...
#ifndef STM32WBAxx_HAL_HASH_H
#define STM32WBAxx_HAL_HASH_H
...
#define IS_HASH_ALGORITHM(__ALGORITHM__) (((__ALGORITHM__) == HASH_ALGOSELECTION_SHA1)|| \
                                          ((__ALGORITHM__) == HASH_ALGOSELECTION_MD5)|| \
