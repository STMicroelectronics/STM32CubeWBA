/**
  ******************************************************************************
  * @file    b_wba5m_wpan_motion_sensors_ex.c
...
/* Includes ------------------------------------------------------------------*/
#include "b_wba5m_wpan_motion_sensors_ex.h"
...
/** @defgroup B_WBA5M_WPAN_MOTION_SENSOR_EX B_WBA5M_WPAN MOTION SENSOR EX
  * @{
  */

/** @defgroup B_WBA5M_WPAN_MOTION_SENSOR_EX_Imported_Variables B_WBA5M_WPAN MOTION SENSOR EX Imported Variables
  * @{
  */
...
/** @defgroup B_WBA5M_WPAN_MOTION_SENSOR_EX_Exported_Functions B_WBA5M_WPAN MOTION SENSOR EX Exported Functions
  * @{
  */
