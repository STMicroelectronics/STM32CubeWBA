/**
  ******************************************************************************
  * @file    b_wba5m_wpan_eeprom.c
  * @author  MCD Application Team
  * @brief   This file provides a set of functions needed to manage an I2C M24256
  *          EEPROM memory mounted on the B_WBA5M_WPAN board(MB1551).
  ******************************************************************************
  * @attention
  *
  ...
  *           from/to this memory. The needed STM32WBAxx hardware resources (I2C and
  *           GPIO) are defined in b_wba5m_wpan_bus.h file, and the initialization is
  ...
  *                 an EEPROM instance. On the B_WBA5M_WPAN board, there's one instance. Therefore,
  *                 this parameter should be 0.
  * @endverbatim
  ******************************************************************************
  */
/* Includes ------------------------------------------------------------------*/
#include "b_wba5m_wpan_eeprom.h"
...
/** @defgroup B_WBA5M_WPAN_EEPROM EEPROM
  * @{
  */

/** @defgroup B_WBA5M_WPAN_EEPROM_Exported_Variables EEPROM Exported Variables
  * @{
  */
...
/** @defgroup B_WBA5M_WPAN_EEPROM_Private_Variables EEPROM Private Variables
  * @{
  */
...
/** @defgroup B_WBA5M_WPAN_EEPROM_Private_Function_Prototypes EEPROM Private Functions Prototypes
  * @{
  */
...
/** @defgroup B_WBA5M_WPAN_EEPROM_Exported_Functions EEPROM Exported Functions
  * @{
  */
/**
...
/** @defgroup B_WBA5M_WPAN_EEPROM_Private_Functions EEPROM Private Functions
  * @{
  */
/**
...
static int32_t M24256_Probe(void)
{
  ...
  IOCtx.Init        = B_WBA5M_WPAN_I2C_Init;
  IOCtx.DeInit      = B_WBA5M_WPAN_I2C_DeInit;
  IOCtx.Read        = B_WBA5M_WPAN_I2C_ReadReg16;
  IOCtx.Write       = B_WBA5M_WPAN_I2C_WriteReg16;
  IOCtx.IsReady     = B_WBA5M_WPAN_I2C_IsReady;
