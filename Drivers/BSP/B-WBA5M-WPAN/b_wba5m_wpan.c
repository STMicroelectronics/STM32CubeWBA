...
/** @defgroup B_WBA5M_WPAN B_WBA5M_WPAN
  * @{
  */

/** @defgroup B_WBA5M_WPAN_COMMON B_WBA5M_WPAN COMMON
  * @brief This file provides set of firmware functions to manage Leds and push-button
  *        available on B-WBA5M-WPAN Kit from STMicroelectronics.
  * @{
  */

/** @defgroup B_WBA5M_WPAN_COMMON_Private_Defines B_WBA5M_WPAN COMMON Private Defines
  * @{
  */
...
/** @defgroup B_WBA5M_WPAN_COMMON_Private_TypesDefinitions B_WBA5M_WPAN COMMON Private Types Definitions
  * @{
  */
...
/** @defgroup B_WBA5M_WPAN_COMMON_Private_FunctionPrototypes B_WBA5M_WPAN COMMON Private Function Prototypes
  * @{
  */
...
/** @defgroup B_WBA5M_WPAN_COMMON_Exported_Variables B_WBA5M_WPAN COMMON Exported Variables
  * @{
  */
#if (USE_BSP_COM_FEATURE == 1)
...
/** @defgroup B_WBA5M_WPAN_COMMON_Private_Variables B_WBA5M_WPAN COMMON Private Variables
  * @{
  */
static uint16_t      LED_PIN[LEDn]  = {LD1_PIN};
static GPIO_TypeDef *LED_PORT[LEDn] = {LD1_GPIO_PORT};

static uint16_t           BUTTON_PIN[BUTTONn]  = {B2_PIN};
static GPIO_TypeDef      *BUTTON_PORT[BUTTONn] = {B2_GPIO_PORT};
static IRQn_Type          BUTTON_IRQn[BUTTONn] = {B2_EXTI_IRQn};
...
/** @defgroup B_WBA5M_WPAN_COMMON_Exported_Functions B_WBA5M_WPAN COMMON Exported Functions
  * @{
  */

/**
  * @brief  This method returns the B-WBA5M-WPAN BSP Driver revision.
  * @retval version : 0xXYZR (8bits for each decimal, R for RC).
  */
int32_t BSP_GetVersion(void)
{
  return ((int32_t)B_WBA5M_WPAN_BSP_VERSION);
}
...
{
  return (const uint8_t*)B_WBA5M_WPAN_BSP_BOARD_NAME;
}
...
{
  return (const uint8_t*)B_WBA5M_WPAN_BSP_BOARD_ID;
}

/** @defgroup B_WBA5M_WPAN_COMMON_LED_Functions B_WBA5M_WPAN COMMON LED Functions
  * @{
  */
...
/** @defgroup B_WBA5M_WPAN_COMMON_BUTTON_Functions B_WBA5M_WPAN_COMMON BUTTON Functions
  * @{
  */
...
int32_t BSP_PB_Init(Button_TypeDef Button, ButtonMode_TypeDef ButtonMode)
{
  ...
  GPIO_InitTypeDef      GPIO_Init;
  uint32_t              BSP_BUTTON_IT_PRIO[BUTTONn] = {BSP_B2_IT_PRIORITY};
  uint32_t              BUTTON_EXTI_LINE[BUTTONn]   = {B2_EXTI_LINE};
  BSP_EXTI_LineCallback ButtonCallback[BUTTONn]     = {B2_EXTI_Callback};
...
#if (USE_BSP_COM_FEATURE == 1)
/** @defgroup B_WBA5M_WPAN_COMMON_COM_Functions B_WBA5M_WPAN COMMON COM Functions
  * @{
  */
...
#else /* (USE_HAL_UART_REGISTER_CALLBACKS == 0) */
...
/** @defgroup B_WBA5M_WPAN_COMMON_Private_Functions B_WBA5M_WPAN COMMON Private Functions
  * @{
  */
