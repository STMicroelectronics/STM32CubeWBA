/**
  ******************************************************************************
  * @file    stm32wba65i_discovery.h
  * @author  MCD Application Team
  * @brief   This file contains definitions for STM32WBA65I_DK1:
  *          LEDs
  *          Joystick
  *          COM port
  *          hardware resources.
...
#ifndef STM32WBA65I_DK1_H
#define STM32WBA65I_DK1_H
...
/** @addtogroup STM32WBA65I_DK1_COMMON
  * @{
  */
...
/** @defgroup STM32WBA65I_DK1_COMMON_Exported_Constants STM32WBA65I-DK1 COMMON Exported Constants
  ...
  */
/**
  * @brief  Define for STM32WBA65I_DK1 board
  */
#if !defined (USE_STM32WBA65I_DK1)
#define USE_STM32WBA65I_DK1
#endif /* USE_STM32WBA65I_DK1 */

/**
  * @brief STM32WBA65I_DK1 BSP Driver version number
  */
...
#define STM32WBA65I_DK1_BSP_VERSION        ((STM32WBA65I_DK1_BSP_VERSION_MAIN << 24)\
                                            ...
                                            |(STM32WBA65I_DK1_BSP_VERSION_SUB2 << 8 )\
                                            |(STM32WBA65I_DK1_BSP_VERSION_RC))
...
#define LD5_GPIO_CLK_ENABLE()                  __HAL_RCC_GPIOD_CLK_ENABLE()
#define LD5_PIN                                GPIO_PIN_9
#define LD6_GPIO_PORT                          GPIOD
#define LD6_GPIO_CLK_ENABLE()                  __HAL_RCC_GPIOD_CLK_ENABLE()
...
#define JOY1_ADC_CHANNEL                        ADC_CHANNEL_6
...
#define JOY1_CHANNEL_GPIO_PIN                   GPIO_PIN_3
...
/** @addtogroup STM32WBA65I_DK1_COMMON_Exported_Variables
  * @{
  */
#if (USE_BSP_COM_FEATURE == 1)
...
/** @addtogroup STM32WBA65I_DK1_COMMON_Exported_Functions
  * @{
  */
...
/** @addtogroup STM32WBA65I_DK1_COMMON_LED_Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE == 1)
/** @addtogroup STM32WBA65I_DK1_COMMON_COM_Functions
  * @{
  */
...
/** @addtogroup STM32WBA65I_DK1_COMMON_JOY_Functions
  * @{
  */
