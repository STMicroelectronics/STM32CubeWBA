/**
  ******************************************************************************
  * @file    stm32wba65i_discovery_lcd.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stm32wba65i_discovery_lcd.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32WBA65I_DISCOVERY_LCD_H
#define STM32WBA65I_DISCOVERY_LCD_H
...
/** @defgroup STM32WBA65I_LCD_Exported_Constants Exported Constants
  * @{
  */
...
/**
  ...
  */
#define LCD_CS_PIN                      GPIO_PIN_1                  /* PE. 01 */
#define LCD_CS_GPIO_PORT                GPIOE                       /* GPIOE  */
#define LCD_CS_GPIO_CLK_ENABLE()        __HAL_RCC_GPIOE_CLK_ENABLE()
#define LCD_CS_GPIO_CLK_DISABLE()       __HAL_RCC_GPIOE_CLK_DISABLE()
...
/**
  ...
  */
#define LCD_RST_PIN                     GPIO_PIN_3                  /* PE. 03 */
#define LCD_RST_GPIO_PORT               GPIOE                       /* GPIOE  */
#define LCD_RST_GPIO_CLK_ENABLE()       __HAL_RCC_GPIOE_CLK_ENABLE()
#define LCD_RST_GPIO_CLK_DISABLE()      __HAL_RCC_GPIOE_CLK_DISABLE()
...
/**
  * @brief
  */
#define LCD_DC_PIN                      GPIO_PIN_0                  /* PE. 00 */
#define LCD_DC_GPIO_PORT                GPIOE                       /* GPIOE  */
#define LCD_DC_GPIO_CLK_ENABLE()        __HAL_RCC_GPIOE_CLK_ENABLE()
#define LCD_DC_GPIO_CLK_DISABLE()       __HAL_RCC_GPIOE_CLK_DISABLE()

/**
  * @}
  */

/** @defgroup STM32WBA65I_LCD_Exported_Types Exported Types
  * @{
  */
typedef struct
{
...
/** @addtogroup STM32WBA65I_LCD_Private_Variables
  * @{
  */
...
/** @defgroup STM32WBA65I_LCD_Exported_Functions Exported Functions
  * @{
  */
...
#endif /* STM32WBA65I_DISCOVERY_LCD_H */
