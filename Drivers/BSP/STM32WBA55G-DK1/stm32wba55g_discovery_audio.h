/**
  ******************************************************************************
  * @file    stm32wba55g_discovery_audio.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stm32wba55g_discovery_audio.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32WBA55G_DK1_AUDIO_H
#define STM32WBA55G_DK1_AUDIO_H
...
/** @addtogroup STM32WBA55G_DK1_AUDIO
  * @{
  */

/** @defgroup STM32WBA55G_DK1_AUDIO_Exported_Types AUDIO Exported Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32WBA55G_DK1_AUDIO_Exported_Constants AUDIO Exported Constants
  * @{
  */
...
#define AUDIO_OUT_SAI                           SAI1_Block_B
#define AUDIO_OUT_SAI_CLK_ENABLE()              __HAL_RCC_SAI1_CLK_ENABLE()
#define AUDIO_OUT_SAI_CLK_DISABLE()             __HAL_RCC_SAI1_CLK_DISABLE()

#define AUDIO_OUT_SAI_MCLK_ENABLE()             __HAL_RCC_GPIOB_CLK_ENABLE()
#define AUDIO_OUT_SAI_MCLK_GPIO_PORT            GPIOB
...
#define AUDIO_OUT_SAI_FS_PIN                    GPIO_PIN_5
...
#define AUDIO_NRST_PIN                          GPIO_PIN_2
...
#define AUDIO_OUT_SAI_DMA_REQUEST               GPDMA1_REQUEST_SAI1_B
...
------------------------------------------------------------------------------*/
/* SAI peripheral configuration defines */
#define AUDIO_IN_SAI                                SAI1_Block_A
...
#define AUDIO_IN_SAI_SD_ENABLE()                    __HAL_RCC_GPIOB_CLK_ENABLE()
#define AUDIO_IN_SAI_SD_GPIO_PORT                   GPIOB
#define AUDIO_IN_SAI_SD_PIN                         GPIO_PIN_14

/* SAI DMA channel definitions */
#define AUDIO_IN_SAI_DMA_CLK_ENABLE()              __HAL_RCC_GPDMA1_CLK_ENABLE()
#define AUDIO_IN_SAI_DMA_CHANNEL                   GPDMA1_Channel1
#define AUDIO_IN_SAI_DMA_REQUEST                   GPDMA1_REQUEST_SAI1_A
...
#define AUDIO_IN_SAI_PDM_CLK_IN_ENABLE()            __HAL_RCC_GPIOA_CLK_ENABLE()
#define AUDIO_IN_SAI_PDM_CLK_IN_PIN                 GPIO_PIN_9
#define AUDIO_IN_SAI_PDM_CLK_IN_PORT                GPIOA
#define AUDIO_IN_SAI_PDM_DATA_IN_ENABLE()           __HAL_RCC_GPIOA_CLK_ENABLE()
#define AUDIO_IN_SAI_PDM_DATA_IN_PIN                GPIO_PIN_10
#define AUDIO_IN_SAI_PDM_DATA_IN_PORT               GPIOA
#define AUDIO_IN_SAI_PDM_DATA_CLK_AF                GPIO_AF3_SAI1
#define AUDIO_IN_SAI_PDM_IRQ                        SAI1_IRQn

/* SAI PDM DMA channel definitions */
...
/** @addtogroup STM32WBA55G_DK1_AUDIO_Exported_Variables
  * @{
  */
...
/** @defgroup STM32WBA55G_DK1_AUDIO_OUT_Exported_Functions AUDIO OUT Exported Functions
  * @{
  */
...
/** @defgroup STM32WBA55G_DK1_AUDIO_IN_Exported_Functions AUDIO IN Exported Functions
  * @{
  */
