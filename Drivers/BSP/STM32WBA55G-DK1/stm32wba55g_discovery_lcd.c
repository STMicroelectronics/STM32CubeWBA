/**
  ******************************************************************************
  * @file    stm32wba55g_discovery_lcd.c
  * @author  MCD Application Team
  * @brief   This file includes the driver for Liquid Crystal Display (LCD) module
  *          mounted on STM32WBA55G discovery board.
  ******************************************************************************
  * @attention
  *
...
---------------------
  ...
  --------
    ...
    an LCD instance. On the STM32WBA55G board, there's one instance. Then, this
...
/** @defgroup STM32WBA55G_LCD_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32WBA55G_LCD_Private_Macros Private Macros
  * @{
  */
...
/** @defgroup STM32WBA55G_LCD_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32WBA55G_LCD_Private_Variables Private Variables
  * @{
  */
...
/** STM32WBA55G_LCD_Private_FunctionPrototypes Private Functions
  */
/*******************************************************************************
 ********************************* LINK LCD ***********************************/
...
/** @addtogroup STM32WBA55G_LCD_Exported_Functions
  * @{
  */
/**
...
int32_t BSP_LCD_SendData(uint8_t *pData, uint16_t Length)
{
  ...
  else
  {
    ...
    /* Check if Length exceed max lcd size */
    if(Length > (SSD1315_LCD_COLUMN_NUMBER * SSD1315_LCD_PAGE_NUMBER))
    {
      ret = BSP_ERROR_WRONG_PARAM;
    }
    /* Check if Length exceed max datasize supported by SPI3 (Limited instance. Datasize Max:0x3FF */
    else if(Length > BUS_SPI3_TSIZE_MAX)
    {
       /* Send first part of Data */
      if(BSP_SPI3_Send(pData, BUS_SPI3_TSIZE_DIV2)!= BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_BUS_FAILURE;
      }
      /* Send second part of Data */
      if(BSP_SPI3_Send(pData+BUS_SPI3_TSIZE_DIV2, BUS_SPI3_TSIZE_DIV2)!= BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_BUS_FAILURE;
      }
    }
...
/** @defgroup STM32WBA55G_LCD_Private_Functions Private Functions
  * @{
  */
