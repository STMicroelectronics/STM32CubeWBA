/**
  ...
  * @brief   Implementation of mbedtls_alt Middleware ECP module
  ******************************************************************************
  * @attention
  *
...
/**
  ...
  *
  * This file implements ECP scalar mul and point checkbased on STM32 PKA
 ...
 *
 */
#if defined(MBEDTLS_HAL_ECP_ALT)
                        ...
                        mbedtls_ecp_restart_ctx *rs_ctx)
{
  ...
  PKA_ECCMulExInTypeDef ECC_MulIn = {0};
  ...
  ECC_MulIn.primeOrderSize = grp->st_order_size;
  ...
  MBEDTLS_MPI_CHK((HAL_PKA_ECCMulEx(&hpka, &ECC_MulIn,
...
static int ecp_check_pubkey_sw(const mbedtls_ecp_group *grp, const mbedtls_ecp_point *pt)
{
  ...
  MBEDTLS_MPI_CHK(mbedtls_ecp_point_write_binary(grp, pt, MBEDTLS_ECP_PF_UNCOMPRESSED, &olen, pt_binary,
                                                 (2U * grp->st_modulus_size) + 1U));
  ...
  MBEDTLS_MPI_CHK((HAL_PKA_MontgomeryParam(&hpka, &inp,
                                           ST_ECP_TIMEOUT) != HAL_OK) ? MBEDTLS_ERR_PLATFORM_HW_ACCEL_FAILED : 0);
  ...
  MBEDTLS_MPI_CHK((HAL_PKA_PointCheck(&hpka, &ECC_PointCheck,
                                      ST_ECP_TIMEOUT) != HAL_OK) ? MBEDTLS_ERR_PLATFORM_HW_ACCEL_FAILED : 0);
