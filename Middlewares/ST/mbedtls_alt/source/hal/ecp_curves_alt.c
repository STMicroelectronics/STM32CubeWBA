/**
  ...
  * @brief   Implementation of mbedtls_alt ECP CURVES module
  ******************************************************************************
  * @attention
  *
...
/**
  ...
  *
  * This file implements EC group load based on STM32 PKA hardware crypto accelerator.
  */
...
#define ECP_CURVE25519_PRIVATE_KEY_BITS     255
#define ECP_CURVE448_PRIVATE_KEY_BITS       448
/*
...
#endif /* MBEDTLS_ECP_DP_SECPxxxX1_ENABLED */
...
static int ecp_use_curve25519(mbedtls_ecp_group *grp)
{
  ...
  grp->nbits = ECP_CURVE25519_PRIVATE_KEY_BITS - 1;
...
static int ecp_use_curve448(mbedtls_ecp_group *grp)
{
  ...
  /* Actually, the required msb for private keys */
  grp->nbits = ECP_CURVE448_PRIVATE_KEY_BITS - 1;
...
static int ecp_mod_p448(mbedtls_mpi *N)
{
  ...
  mbedtls_mpi M;
  mbedtls_mpi Q;
  mbedtls_mpi_uint Mp[P448_WIDTH + 1];
  mbedtls_mpi_uint Qp[P448_WIDTH];
