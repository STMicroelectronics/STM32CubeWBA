...
enum ZbZclDrlcCriticalityLevelT {
    ZCL_DRLC_CRIT_LEVEL0_DESC_RES = 0, /**< Reserved */
    ZCL_DRLC_CRIT_LEVEL1_DESC_GREEN = 1, /**< Green */
    ZCL_DRLC_CRIT_LEVEL2_DESC_1 = 2, /**< 1 */
    ZCL_DRLC_CRIT_LEVEL3_DESC_2 = 3, /**< 2 */
    ZCL_DRLC_CRIT_LEVEL4_DESC_3 = 4, /**< 3 */
    ZCL_DRLC_CRIT_LEVEL5_DESC_4 = 5, /**< 4 */
    ZCL_DRLC_CRIT_LEVEL6_DESC_5 = 6, /**< 5 */
    ZCL_DRLC_CRIT_LEVEL7_DESC_EMERGENCY = 7, /**< Emergency */
    ZCL_DRLC_CRIT_LEVEL8_DESC_PLANNED_OUTAGE = 8, /**< Planned Outage */
    ZCL_DRLC_CRIT_LEVEL9_DESC_DISCONNECT = 9, /**< Service Disconnect */
    ZCL_DRLC_CRITICALITY_UTILITY_MIN = 0x0A, /**< Utility Defined (min) */
    ZCL_DRLC_CRITICALITY_UTILITY_MAX = 0x0F /**< Utility Defined (max) */
};
...
/* As per command structure from SE 1.4 specification,
 * section D.2.3.3.1 Report Event Status Command */
#define ZCL_DRLC_REPORT_EVENT_STATUS_SIZE       (60U)
...
struct ZbZclDrlcStatusT {
    ...
    uint16_t cool_setpoint_applied;
    /**< Cooling Temperature Set Point Applied (Optional).
     * Set to ZCL_DRLC_COOL_SETPOINT_IGNORED if not used */
    uint16_t heat_setpoint_applied;
    /**< Heating Temperature Set Point Applied (Optional).
     * Set to ZCL_DRLC_HEAT_SETPOINT_IGNORED if not used */
    int8_t avg_load_adj_applied;
    /**< Average Load Adjustment Percentage Applied (Optional).
     * Set to ZCL_DRLC_AVG_LOAD_ADJ_IGNORED if not used */
    uint8_t dutycycle_applied;
    /**< Duty Cycle Applied (Optional). Set to ZCL_DRLC_DUTYCYCLE_IGNORED if not used */
 ...
 * @param cluster Cluster instance from which to send this command
 * @param eventList Holds a pointer to the opt-outs list if successful
 * @return ZCL_STATUS_SUCCESS if successful, or other ZclStatusCodeT value on error
 */
