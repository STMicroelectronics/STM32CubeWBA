...
enum ZbZclGlobalAttrT {
     ...
     * The application can use ZbZclAttrIntegerWrite to update the attribute to a
     * different value.
     */
...
enum ZclStatusCodeT {
    ...
    /* ZCL_STATUS_UNSUPP_CLUSTER_COMMAND deprecated. Changed to ZCL_STATUS_UNSUPP_COMMAND. */
...
enum ZbZclClusterIdT {
    ...
    ZCL_CLUSTER_SUBGHZ = 0x070B, /* SE 1.4 */
