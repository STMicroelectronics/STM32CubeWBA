...
typedef struct ZbZgpProxyTableEntryT {
    ...
    /* sequence of octets 2 entries A.3.4.2.2.2 */
    ...
    /* sequence of octets  2 entries A.3.4.2.2.2 */
    ZbZgpLightweightSinkAddressT full_unicast_sink_address_list[ZB_ZGP_FULL_UNICAST_SINK_ADDRESS_LIST_ENTRIES];
...
/* EXEGIN - was ZGP_PAIR_FULL_UNICAST_FORWARDING_OF_THE_GP_NOTIFICATION */
#define ZGP_PAIR_FULL_UNICAST_FWD_GP_NOTIF                              0x000000
/* EXEGIN - was ZGP_PAIR_GROUPCAST_FORWARDING_OF_THE_GP_NOTIFICATION_COMMAND_TO_DGROUPID */
#define ZGP_PAIR_GROUPCAST_FWD_GP_NOTIF_CMD_TO_GROUPID                  0x000020
/* EXEGIN - was ZGP_PAIR_GROUPCAST_FORWARDING_OF_THE_GP_NOTIFICATION_COMMAND_TO_PRE_COMMISSIONED_GROUPID */
#define ZGP_PAIR_GROUPCAST_FWD_GP_NOTIF_CMD_TO_PRE_COMMIS_GROUPID       0x000040
/* EXEGIN - was ZGP_PAIR_UNICAST_FORWARDING_OF_THE_GP_NOTIFICATION_COMMAND_BY_THE_LIGHTWEIGHT_UNICAST_FUNCTIONALITY */
#define ZGP_PAIR_UNICAST_FWD_GP_NOTIF_CMD_BY_LW_UNICAST_FUNC            0x000060
