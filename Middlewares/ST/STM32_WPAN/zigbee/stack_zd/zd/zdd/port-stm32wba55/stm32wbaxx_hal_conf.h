...
#ifndef APPLICATION_USE_BAREMETAL
#define HAL_TIM_MODULE_ENABLED
#endif // APPLICATION_USE_BAREMETAL
...
#define  TICK_INT_PRIORITY            (14U)    /*!< tick interrupt priority (lowest by default) , it's set to second lowest priority in the system as  
                                                    lowest priority , in case of using RTOS , is PendSVC interrupt */
#define  USE_RTOS                     0U
