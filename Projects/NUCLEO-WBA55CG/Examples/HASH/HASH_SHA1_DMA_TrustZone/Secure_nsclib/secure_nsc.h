...
/* Secure HASH SHA-1 computation with 8-bits data type */
ErrorStatus SECURE_HASH_SHA1_8BITS(uint8_t *pInputData, uint32_t InputDataSize, uint8_t *pOutputSignature);
