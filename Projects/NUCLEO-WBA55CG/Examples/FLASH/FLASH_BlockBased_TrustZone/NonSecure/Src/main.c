...
int main(void)
{
  ...
  */
  ...
  /* Check if the programmed data is OK
      MemoryProgramStatus = 0: read as '0' because access to secure not allowed
  ...
  /* Call secure code to deactivate block-based security */
  SECURE_FLASH_BlockBasedDeactivation();
