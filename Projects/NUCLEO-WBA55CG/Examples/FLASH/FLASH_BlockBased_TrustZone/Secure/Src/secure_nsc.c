...
CMSE_NS_ENTRY void SECURE_FLASH_BlockBasedDeactivation(void)
{
  ...
  BBSecInitStruct.BBAttributes_array[0] = 0xFFFFFFFFU;
  BBSecInitStruct.BBAttributes_array[1] = 0xFFFFFFFFU;
  BBSecInitStruct.BBAttributes_array[2] = 0U;
  BBSecInitStruct.BBAttributes_array[3] = 0U;
