...
/**
  ******************************************************************************
  * File Name          : TIM/TIM_DMABurst/Src/stm32wbaxx_hal_msp.c
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    handle_GPDMA1_Channel2.Init.Request = GPDMA1_REQUEST_TIM2_UP;
    ...
    __HAL_LINKDMA(htim_pwm, hdma[TIM_DMA_ID_UPDATE], handle_GPDMA1_Channel2);
