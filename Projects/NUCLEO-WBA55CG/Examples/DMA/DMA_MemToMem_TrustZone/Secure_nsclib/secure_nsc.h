...
ErrorStatus SECURE_DMA_Secure_To_NonSecure(uint32_t *pBufferDst, uint32_t Size, void *pCallback);
ErrorStatus SECURE_DMA_NonSecure_To_Secure(uint32_t *pBufferSrc, uint32_t Size, void *pCallback);
ErrorStatus SECURE_DATA_Last_Buffer_Compare(void);
