...
/**
  ...
  * @brief   This example code shows how to use STM32WBAxx LPTIM HAL API to realize a
...
int main(void)
{
   ...
   */
  if (HAL_LPTIM_TimeOut_Start_IT(&hlptim1, TIMEOUT) != HAL_OK)
  {
    Error_Handler();
  }
...
{
  /* Timeout was reached, toggle LD1 */
  BSP_LED_Toggle(LD1);
}
/* USER CODE END 4 */
