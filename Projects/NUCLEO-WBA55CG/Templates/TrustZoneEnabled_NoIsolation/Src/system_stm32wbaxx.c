...
void SecureSystemInit(void)
{
  ...
  RCC->AHB2ENR |= 0x403F0087UL;
  RCC->AHB4ENR |= 0x00000024UL;
  RCC->AHB5ENR |= 0x00000003UL;
  RCC->APB1ENR1 |= 0x00220803UL;
  RCC->APB1ENR2 |= 0x00000020UL;
  RCC->APB2ENR  |= 0x00265800UL;
  RCC->APB7ENR  |= 0x002088E2UL;

  /* Illegal access interrupts configuration */
  GTZC_TZIC->IER1 |= 0x000222C3UL;
  GTZC_TZIC->IER2 |= 0x018F00EBUL;
  GTZC_TZIC->IER3 |= 0x01C1F858UL;
  GTZC_TZIC->IER4 |= 0xC3C0EF87UL;

  /* Securable peripherals security and privilege management */
  GTZC_TZSC->SECCFGR1  |= 0x000222C3UL;
  GTZC_TZSC->SECCFGR2  |= 0x018F00EBUL;
  GTZC_TZSC->SECCFGR3  |= 0x01C17858UL;
