## __Zigbee_OnOff_Server_Coord_R22 Application Description__
...
* One STM32WBA55xx Nucleo board loaded with application **Zigbee_OnOff_Server_Coord_R22**
* One or more STM32WBA55xx board loaded with application **Zigbee_OnOff_Client_Router_R22**
</br>
...
* To run the application :
	1. Start the first board. It must be the coordinator of the Zigbee network so in this demo application it is the device running Zigbee_OnOff_Server_Coord_R22 application.  
