...
#define APP_ZIGBEE_CLUSTER1_NAME          "Diagnostics Server"

#define APP_ZIGBEE_CLUSTER2_ID            ZCL_CLUSTER_ONOFF
#define APP_ZIGBEE_CLUSTER2_NAME          "OnOff Client"

/* Diagnostics specific defines ----------------------------------------------------*/
#define APP_ZIGBEE_MIN_SECURITY           ZB_APS_STATUS_UNSECURED
/* USER CODE BEGIN Diagnostics defines */
/* USER CODE END Diagnostics defines */
...
#define DiagnosticsServer                 pstZbCluster[0]
#define OnOffClient                       pstZbCluster[1]
...
void APP_ZIGBEE_ConfigEndpoints(void)
{
  ...
  /* Add Diagnostics Server Cluster */
  if ( ZbZclDiagServerAlloc( stZigbeeAppInfo.pstZigbee, APP_ZIGBEE_ENDPOINT, APP_ZIGBEE_PROFILE_ID, APP_ZIGBEE_MIN_SECURITY ) == false )
  {
    LOG_ERROR_APP( "Error : Diagnostic Server Cluster allocation failed." );
  }
