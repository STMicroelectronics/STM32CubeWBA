## __Zigbee_PowerConfig_Server_SED Application Description__
...
if you want to have the Led Blue on on SED side when attached to the network, you can modify the **CFG_FULL_LOW_POWER** to the value **0**.  	 
