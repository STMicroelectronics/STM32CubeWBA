...
/**
 * @brief  Management of the SW2 button. Open a Join Window.
 * @param  None
 * @retval None
 */
void APP_BSP_Button2Action(void)
{
  ...
  {
    /*  Open a Permit to Join Window during 60 seconds */
    APP_ZIGBEE_PermitJoin( 60 );
  }
}

/**
 * @brief  Management of the SW3 button. Erase Persistence & Reset.
 * @param  None
 * @retval None
 */
void APP_BSP_Button3Action(void)
{
  /* Erase all Persistence data */
  AppZbPersistence_EraseAllData();

  /* Wait to be sure Erase is complete & Reset */
  HAL_Delay( 1000u );
  NVIC_SystemReset();
}
