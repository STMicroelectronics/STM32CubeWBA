...
typedef enum
{
  ...
  CFG_EVENT_THREAD_SNVMA_WRITE_ENDED,
...
#define EVENT_THREAD_SNVMA_WRITE_ENDED          ( 1U << CFG_EVENT_THREAD_SNVMA_WRITE_ENDED )
...
#define CFG_SNVMA_START_SECTOR_ID     ((FLASH_SIZE / FLASH_PAGE_SIZE) - 7u)
