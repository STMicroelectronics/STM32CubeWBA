...
{
  UTIL_SEQ_SetTask( 1U<< CFG_TASK_OT_ALARM, CFG_SCH_OT_ALARM);
}

void APP_THREAD_ScheduleUsAlarm(void)
{
  UTIL_SEQ_SetTask( 1U<< CFG_TASK_OT_US_ALARM, CFG_SCH_OT_US_ALARM);
}
...
void Thread_Init(void)
{
  ...
  UTIL_SEQ_SetTask( 1U<< CFG_TASK_OT_ALARM, CFG_SCH_OT_ALARM);
#if (OT_CLI_USE == 1)
  UTIL_SEQ_SetTask( 1U<< CFG_TASK_OT_UART, CFG_SCH_OT_TASKLETS);
#endif
}
...
{
  UTIL_SEQ_SetTask( 1U<< CFG_TASK_OT_TASKLETS, CFG_SCH_OT_TASKLETS);
}
...
{
  UTIL_SEQ_SetTask( 1U<< CFG_TASK_OT_UART, CFG_SCH_OT_UART);
}
