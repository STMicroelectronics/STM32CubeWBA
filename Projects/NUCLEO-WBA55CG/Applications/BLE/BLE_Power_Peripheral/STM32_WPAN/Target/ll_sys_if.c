...
void ll_sys_config_params(void)
{
 ...
 Evnt_timing_t custom_timings;
 custom_timings.drift_time = 12;
 custom_timings.exec_time = 17;
 custom_timings.schdling_time = 20;
...
ll_intf_config_schdling_time(&custom_timings);
#if (USE_TEMPERATURE_BASED_RADIO_CALIBRATION == 1)
