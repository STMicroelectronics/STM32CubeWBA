...
#ifdef APP_THREAD_PERIODIC_TRANSMIT  
  /* Create task for periodic CoAp msg transmission */
  UTIL_SEQ_RegTask(1U << CFG_TASK_SEND_COAP_MSG, UTIL_SEQ_RFU, APP_THREAD_SendCoapMsgWithNoConf);
...
static void APP_THREAD_TransmitRequest(void *arg)
{
  UTIL_SEQ_SetTask(1U << CFG_TASK_SEND_COAP_MSG, CFG_SEQ_PRIO_1);
}
#endif
