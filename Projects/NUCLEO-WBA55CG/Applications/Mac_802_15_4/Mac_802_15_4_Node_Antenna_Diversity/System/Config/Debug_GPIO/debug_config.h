...
#define USE_RT_DEBUG_AD_SET_MEASUREMENT_STATE                 (1)
#define GPIO_DEBUG_AD_SET_MEASUREMENT_STATE                   {GPIOA, GPIO_PIN_5}
...
#if (USE_RT_DEBUG_AD_SET_MEASUREMENT_STATE == 1)
  [RT_DEBUG_AD_SET_MEASUREMENT_STATE] = GPIO_DEBUG_AD_SET_MEASUREMENT_STATE,
#endif /* USE_RT_DEBUG_AD_SET_MEASUREMENT_STATE */
