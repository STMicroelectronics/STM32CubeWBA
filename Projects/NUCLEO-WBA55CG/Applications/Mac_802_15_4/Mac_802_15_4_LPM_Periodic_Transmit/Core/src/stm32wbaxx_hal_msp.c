...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PeriphClkInit.Lpuart1ClockSelection = LL_RCC_LPUART1_CLKSOURCE_HSI;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
    {
      Error_Handler();
    }    
    ...
    */
    ...
    /* LPUART1 DMA Init */
    /* LPUART1_TX Init */
    hdma_lpuart1_tx.Instance = GPDMA1_Channel2;
    hdma_lpuart1_tx.Init.Request = GPDMA1_REQUEST_LPUART1_TX;
    hdma_lpuart1_tx.Init.BlkHWRequest = DMA_BREQ_SINGLE_BURST;
    hdma_lpuart1_tx.Init.Direction = DMA_MEMORY_TO_PERIPH;
    hdma_lpuart1_tx.Init.SrcInc = DMA_SINC_INCREMENTED;
    hdma_lpuart1_tx.Init.DestInc = DMA_DINC_FIXED;
    hdma_lpuart1_tx.Init.SrcDataWidth = DMA_SRC_DATAWIDTH_BYTE;
    hdma_lpuart1_tx.Init.DestDataWidth = DMA_DEST_DATAWIDTH_BYTE;
    hdma_lpuart1_tx.Init.Priority = DMA_LOW_PRIORITY_LOW_WEIGHT;
    hdma_lpuart1_tx.Init.SrcBurstLength = 1;
    hdma_lpuart1_tx.Init.DestBurstLength = 1;
    hdma_lpuart1_tx.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0|DMA_DEST_ALLOCATED_PORT0;
    hdma_lpuart1_tx.Init.TransferEventMode = DMA_TCEM_BLOCK_TRANSFER;
...
void HAL_LPTIM_MspInit(LPTIM_HandleTypeDef* hlptim)
{
  ...
  */
    ...
    PeriphClkInit.Lptim1ClockSelection = RCC_LPTIM1CLKSOURCE_LSE;//RCC_LPTIM1CLKSOURCE_PCLK7
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
    {
      Error_Handler();
    }
