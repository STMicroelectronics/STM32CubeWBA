...
Please note that the internal Flash is fully secure by default in TZEN=1 and User Option Bytes SECWM_PSTRT/SECWM_PEND should be set according to the application configuration.
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics NUCLEO-WBA55CG(MB1803-WBA55CG-B01 and MB1801-USB-D01) board
