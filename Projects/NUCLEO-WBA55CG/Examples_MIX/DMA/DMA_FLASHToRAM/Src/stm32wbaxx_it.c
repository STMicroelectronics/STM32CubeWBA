...
/**
  ******************************************************************************
  * @file    Examples_MIX/DMA/DMA_FLASHToRAM/Src/stm32wbaxx_it.c
...
void GPDMA1_Channel1_IRQHandler(void)
{
  ...
  /* - LL_DMA_IsActiveFlag_TC() to check complete GPDMA1 Interrupt */
  /* - LL_DMA_IsActiveFlag_DTE() to check error GPDMA1 Interrupt   */
  /* - LL_DMA_ClearFlag_TC() to clear all GPDMA1 Interrupts        */
