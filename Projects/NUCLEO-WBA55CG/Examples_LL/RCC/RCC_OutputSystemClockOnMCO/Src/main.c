...
/**
  ...
  *          the system clock through the STM32WBAxx RCC LL API.
  ******************************************************************************
  * @attention
  *
...
static RCC_MCO_ConfigTypeDef aMCO_Config[RCC_MCO_CONFIG_NB] =
{
  ...
  {LL_RCC_MCO1SOURCE_HSE, LL_RCC_MCO1_DIV_1},
};
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetPinPull(EXTI_PIN_GPIO_Port, EXTI_PIN_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinMode(EXTI_PIN_GPIO_Port, EXTI_PIN_Pin, LL_GPIO_MODE_INPUT);
...
void UserButton_Callback(void)
{
  ...
  /* Toggle LD1 to indicate a button press*/
