...
/**
  ******************************************************************************
  * @file    Examples_LL/I2C/I2C_TwoBoards_MasterTx_SlaveRx_DMA_Init/Src/stm32wbaxx_it.c
...
void GPDMA1_Channel0_IRQHandler(void)
{
  ...
  if(LL_DMA_IsActiveFlag_TC(GPDMA1, LL_DMA_CHANNEL_0) == 1)
  {
    ...
    GPDMA1_Transfer_Complete_Callback();
  }
  else if(LL_DMA_IsActiveFlag_DTE(GPDMA1, LL_DMA_CHANNEL_0) == 1)
  {
    GPDMA1_Transfer_Error_Callback();
  }
#endif
...
void GPDMA1_Channel1_IRQHandler(void)
{
  ...
  else if(LL_DMA_IsActiveFlag_DTE(GPDMA1, LL_DMA_CHANNEL_1) == 1)
  {
    GPDMA1_Transfer_Error_Callback();
  }
#endif
