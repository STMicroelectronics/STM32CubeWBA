...
/**
  ******************************************************************************
  * @file    Examples_LL/PWR/PWR_SMPS_64MHZ_HSI_PLL/Src/main.c
  * @author  MCD Application Team
  * @brief   This example describes how to configure the PWR  to SMPS regulator
             with system clock at 64Mhz with HSI and PLL through the STM32WBAxx
             PWR LL API.
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  /* Set SMPS as regulator */
  LL_PWR_SetRegulatorSupply(LL_PWR_SMPS_SUPPLY);

  /* Wait till SMPS regulator supply is well selected */
...
void SystemClock_Config(void)
{
  ...
  LL_RCC_PLL1_ConfigDomain_SYS(LL_RCC_PLL1SOURCE_HSI, 1, 8, 2);
  ...
  LL_RCC_SetAHB5Prescaler(LL_RCC_AHB5_DIV_2);
