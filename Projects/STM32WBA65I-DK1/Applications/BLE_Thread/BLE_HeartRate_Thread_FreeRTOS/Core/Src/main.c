...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : SCK_A_Pin */
  GPIO_InitStruct.Pin = SCK_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.Alternate = GPIO_AF13_SAI1;
  HAL_GPIO_Init(SCK_A_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : SPI3_MISO_Pin SPI3_SCK_Pin */
  ...
  /*Configure GPIO pins : USB_HS_N_Pin USB_HS_P_Pin */
  ...
  /*Configure GPIO pin : SPI3_MOSI_Pin */
  ...
  /*Configure GPIO pin : MCLK_A_Pin */
  GPIO_InitStruct.Pin = MCLK_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.Alternate = GPIO_AF13_SAI1;
  HAL_GPIO_Init(MCLK_A_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : SD_B_Pin FS_A_Pin */
  GPIO_InitStruct.Pin = SD_B_Pin|FS_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.Alternate = GPIO_AF13_SAI1;
