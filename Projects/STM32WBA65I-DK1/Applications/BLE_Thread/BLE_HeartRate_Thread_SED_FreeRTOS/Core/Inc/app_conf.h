 ...
 * In this current DV, the temperature based calibration is not yet supported. It means that the
 * USE_TEMPERATURE_BASED_RADIO_CALIBRATION should be set to 0
*/
...
#define RCC_INTR_PRIO                       (6)           /* HSERDY and PLL1RDY */
