...
/* area for flashing images */
  ...
  RE_BOOT_SHARED_DATA_BASE = BOOT_SHARED_DATA_BASE,
  RE_BOOT_SHARED_DATA_SIZE = BOOT_SHARED_DATA_SIZE,
  RE_BOOT_RAM_BASE = BL2_DATA_START,
  RE_BOOT_RAM_SIZE = BL2_DATA_SIZE,
