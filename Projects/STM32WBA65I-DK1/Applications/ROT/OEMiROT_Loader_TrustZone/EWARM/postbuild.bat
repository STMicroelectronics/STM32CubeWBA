...
set maxbytesize=440
set "loader_s=%projectdir%\Secure\STM32WBA65I-DK1_S\Exe\Project.bin"
set "loader_ns=%projectdir%\NonSecure\STM32WBA65I-DK1_NS\Exe\Project.bin"
...
set "nsclib_source=%projectdir%\Secure\STM32WBA65I-DK1_S\Exe\Project_import_lib.o"
