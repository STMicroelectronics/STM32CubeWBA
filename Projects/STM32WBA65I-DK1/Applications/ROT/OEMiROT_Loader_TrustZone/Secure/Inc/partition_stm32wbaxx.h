...
*/
#define SAU_INIT_START0     NSC_LOADER_START      /* start address of SAU region 0 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END0       (NSC_LOADER_START + NSC_LOADER_SIZE - 1)       /* end address of SAU region 0 */
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START2     NS_DATA_START      /* start address of SAU region 2 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END2       (LOADER_NS_DATA_START + LOADER_NS_DATA_SIZE - 1)       /* end address of SAU region 2 */
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#if defined(STM32WBA65xx) || defined(STM32WBA55xx)
#define SAU_INIT_START4     0x40000000      /* start address of SAU region 4 */
#elif defined(STM32WBA52xx)
#define SAU_INIT_START4     0x0BF88000      /* start address of SAU region 4 */
#else
#error "Unknown target."
#endif
...
#elif defined(STM32WBA52xx)
#define SAU_INIT_END4       0x0BFFFFFF      /* end address of SAU region 4 */
#else
#error "Unknown target."
#endif
