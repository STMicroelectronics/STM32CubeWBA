...
static HAL_StatusTypeDef FW_UPDATE_EraseAllMem(void);
...
static HAL_StatusTypeDef FW_UPDATE_EraseAllMem(void)
{
  ...
  printf("  -- Erasing all external memory \r\n\n");

  LOADER_FLASH_DEV_NAME.EraseChip();
