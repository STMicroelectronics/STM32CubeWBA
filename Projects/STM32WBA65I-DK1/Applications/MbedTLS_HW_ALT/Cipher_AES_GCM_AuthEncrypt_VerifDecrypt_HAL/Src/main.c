/**
  ******************************************************************************
  * @file    MbedTLS_HW_ALT/Cipher_AES_GCM_AuthEncrypt_VerifDecrypt_HAL/Src/main.c
...
int main(void)
{
  ...
  */
  ...
  /* Turn on LD5 in an infinite loop in case of AES GCM operations are successful */
  BSP_LED_On(LD5);
  glob_status = PASSED;
  while (1)
  {}
