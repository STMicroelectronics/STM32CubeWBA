 ...
 */
#define SUPPORTED_SNK_MEDIA_RECEIVER_CONTEXTS   (((APP_TMAP_ROLE & (TMAP_ROLE_UNICAST_MEDIA_RECEIVER )) != (0)) ? (AUDIO_CONTEXT_MEDIA |AUDIO_CONTEXT_ALERTS | AUDIO_CONTEXT_RINGTONE | AUDIO_CONTEXT_SOUND_EFFECTS) : (0))
