...
/**
  ...
  * @brief   Header for gmap_app.c module
  ******************************************************************************
  * @attention
  *
...
#define AUDIO_PROFILE_GMAP                      0x80u

/* Init state */
typedef uint8_t GMAPAPP_InitState_t;
#define GMAP_APP_INIT_STATE_IDLE                 0x00
#define GMAP_APP_INIT_STATE_CAP_LINKUP           0x01
#define GMAP_APP_INIT_STATE_GMAP_LINKUP          0x02
#define GMAP_APP_INIT_STATE_SET_MEMBER_DISC      0x03
#define GMAP_APP_INIT_STATE_SET_VOLUME           0x04
#define GMAP_APP_INIT_STATE_SET_MIC_MUTE         0x05
...
typedef struct
{
  ...
  uint8_t                       SubgroupMetadata[APP_MAX_SUBGROUPS][MAX_BSRC_METADATA_LEN];
  uint8_t                       RTN;
  uint16_t                      MaxTransportLatency;
  uint16_t                      CurrentBISConnHandle[APP_MAX_NUM_BIS];
  uint8_t                       CurrentNumBIS;

  uint8_t                       SinkDecimation;
  uint8_t                       SourceDecimation;
} GMAPAPP_Context_t;
...
void GMAPAPP_AclConnected(uint16_t Conn_Handle,uint8_t Peer_Address_Type,uint8_t Peer_Address[6],uint8_t role);
