...
flash_layout="$cube_fw_path/Projects/STM32WBA65I-DK1/Applications/ROT/OEMiROT_Boot/Inc/flash_layout.h"
boot_cfg_h="$cube_fw_path/Projects/STM32WBA65I-DK1/Applications/ROT/OEMiROT_Boot/Inc/boot_hal_cfg.h"
...
$applicfg definevalue --name=oemurot_enabled  --value=1 "$tmp_oemirot_file" --decimal
