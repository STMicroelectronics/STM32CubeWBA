...
int main(void)
{
  ...
  {
    /* Make LD3 blink with 1s period to indicate an error after programming */
    BSP_LED_On(LD3);
    HAL_Delay(1000);
    BSP_LED_Off(LD3);
    HAL_Delay(1000);
...
void Error_Handler(void)
{
  ...
  while(1)
  {
    /* Make LD3 blink (100ms on, 2s off) when there is an issue during erase or program procedure */
    BSP_LED_On(LD3);
    HAL_Delay(100);
    BSP_LED_Off(LD3);
    HAL_Delay(2000);
