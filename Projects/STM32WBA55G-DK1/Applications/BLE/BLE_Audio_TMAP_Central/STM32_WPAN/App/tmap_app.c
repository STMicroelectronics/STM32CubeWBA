    ...
    case CAP_REM_ACC_SRC_PAC_RECORD_INFO_EVT:
    {
      ...
      if (p_conn != 0)
      {
        if ((pNotification->EvtOpcode == CAP_REM_ACC_SNK_PAC_RECORD_INFO_EVT)
           ...
           && (remote_supported_octet_per_codec_frame >= APP_CodecConf[TARGET_MEDIA_STREAM_QOS_CONFIG%16].octets_per_codec_frame))
        {
        ...
        if ((pNotification->EvtOpcode == CAP_REM_ACC_SNK_PAC_RECORD_INFO_EVT)
           ...
           && (remote_supported_octet_per_codec_frame >= APP_CodecConf[TARGET_TELEPHONY_STREAM_QOS_CONFIG%16].octets_per_codec_frame))
        {
