 ...
 */
#define CFG_GAP_APPEARANCE            (GAP_APPEARANCE_MOUSE)
 ...
 * When CFG_JOYSTICK_SUPPORTED is set, the joystick is activated 
 * When CFG_LCD_SUPPORTED is set, the LCD screen is activated
 */
