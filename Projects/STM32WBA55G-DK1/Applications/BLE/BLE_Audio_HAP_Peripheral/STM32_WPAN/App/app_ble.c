...
/* USER CODE BEGIN EV */
extern HAPAPP_Context_t HAPAPP_Context;
...
#else
  HAPAPP_Init(0);
  uint8_t status = HAPAPP_StartAdvertising(CAP_GENERAL_ANNOUNCEMENT, 0, GAP_APPEARANCE_GENERIC_HEARING_AID);
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          if (p_enhanced_conn_complete->Status == 0)
          {
            ...
            HAPAPP_AclConnected(p_enhanced_conn_complete->Connection_Handle,
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          if (p_conn_complete->Status == 0)
          {
            ...
            HAPAPP_AclConnected(p_conn_complete->Connection_Handle,
        ...
        case HCI_LE_CIS_ESTABLISHED_SUBEVT_CODE:
        {
            ...
            {
              HAPAPP_CISConnected(p_cis_established_event->Connection_Handle);
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
    {
      ...
      switch (p_blecore_evt->ecode)
      {
        ...
        case ACI_GAP_BOND_LOST_VSEVT_CODE:
        {
          ...
          HAPAPP_BondLost(bleAppContext.connectionHandle);
        ...
        case ACI_GATT_INDICATION_VSEVT_CODE:
        {
          ...
          if (p_conn != 0)
          {
            if (p_indication->Attribute_Handle == p_conn->GattService.ServiceChangedCharDescHandle)
            {
              ...
              HAPAPP_BondLost(p_indication->Connection_Handle);
            }
          }
          ...
          if (ret != BLE_STATUS_SUCCESS)
          {
            ...
            HAPAPP_ConfirmIndicationRequired(p_indication->Connection_Handle);
          ...
          if ((p_conn != 0) && (pr->Error_Code == BLE_STATUS_SUCCESS))
          {
            if (p_conn->GattService.LinkupState == GATT_SERVICE_LINKUP_DISC_SERVICE)
            {
              if (p_conn->GattService.StartHandle != 0)
              {
                ...
                {
                  HAPAPP_Linkup(p_conn->ConnHandle);
                }
              }
              else
              {
            ...
            {
              /* End of Gatt Service Linkup: Store database and start HAP App Linkup */
...
static void Ble_Hci_Gap_Gatt_Init(void)
{
  ...
  a_appearance[0] = GAP_APPEARANCE_GENERIC_HEARING_AID;
