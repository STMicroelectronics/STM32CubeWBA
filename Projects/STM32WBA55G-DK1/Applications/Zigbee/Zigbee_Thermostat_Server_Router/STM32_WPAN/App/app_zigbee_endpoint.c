...
void APP_ZIGBEE_ApplicationInit(void)
{
  ...
  UTIL_LCD_DisplayStringAtLine( 0, (uint8_t *)"Therm. Srv" );
  UTIL_LCD_DisplayStringAtLine( 1, (uint8_t *)"Search ..." );
...
#if (CFG_LCD_SUPPORTED == 1)
  UTIL_LCD_DisplayStringAtLine( 1, (uint8_t *)"Ready     " );
  BSP_LCD_Refresh( LCD1 );
#endif /* (CFG_LCD_SUPPORTED == 1) */
...
#if (CFG_LCD_SUPPORTED == 1)
    UTIL_LCD_DisplayStringAtLine( 3, (uint8_t *)szText );
    BSP_LCD_Refresh( LCD1 );
#endif /* (CFG_LCD_SUPPORTED == 1) */
  }
