...
Then the LED_Init() function is used to initialize the LD3.
...
STM32WBA55G-DK1's LD3 can be used to monitor the transfer status:

- LD3 is turned ON if the DMA data transfer is successfully completed.
- LD3 is blinking every 1 sec in case of error.
