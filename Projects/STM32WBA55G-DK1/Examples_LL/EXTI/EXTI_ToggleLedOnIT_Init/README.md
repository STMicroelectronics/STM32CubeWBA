...
In this example, one EXTI line (EXTI line 1) is configured to generate
...
In this example:
    ...
    - EXTI line 1 is connected to PA.01 pin
      - when falling edge is detected on EXTI line 1 by pressing Joystick SEL push-button, LD3 toggles

On STM32WBA55G-DK1:

    - EXTI line 1 is connected to Joystick SEL push-button
