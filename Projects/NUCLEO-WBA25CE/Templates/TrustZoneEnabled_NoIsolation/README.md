...
File | Description
 --- | ---
  ...
  Templates/TrustZoneEnabled_NoIsolation/Inc/stm32wbaxx_nucleo_conf.h | BSP Configuration file
...
- This template has been tested with STMicroelectronics NUCLEO-WBA25CE (MB1801 and MB2293) board and can be easily
