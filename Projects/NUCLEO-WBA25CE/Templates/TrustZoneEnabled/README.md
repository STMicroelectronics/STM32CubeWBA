...
- The reference template project configures the maximum system clock frequency at 64Mhz in non-secure
application.
...
file is as follows:
    ...
    - TZEN=1
    - SECWM_PSTRT=0x00  SECWM_PEND=0x3F  meaning only first 64 pages of Flash set as secure
...
File | Description
 --- | ---
  ...
  Templates/TrustZoneEnabled/Secure/Inc/partition_stm32wba25xx.h    | STM32WBA Device System Configuration file
...
### <b>Hardware and Software environment</b>
  ...
  - This template runs on STM32WBA25CE devices with security enabled (TZEN=1).
  - This template has been tested with STMicroelectronics NUCLEO-WBA25CE (MB1801 and MB2293)
  ...
  - User Option Bytes requirement (with STM32CubeProgrammer tool)
        ...
        - SECWM_PSTRT=0x00   SECWM_PEND=0x3F     Only first 64 pages of Flash set as secure
