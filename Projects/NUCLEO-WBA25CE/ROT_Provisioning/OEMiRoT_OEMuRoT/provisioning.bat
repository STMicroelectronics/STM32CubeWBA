...
set "flash_layout=%cube_fw_path%\Projects\NUCLEO-WBA25CE\Applications\ROT\OEMiROT_Boot\Inc\flash_layout.h"
set boot_cfg_h="%cube_fw_path%\Projects\NUCLEO-WBA25CE\Applications\ROT\OEMiROT_Boot\Inc\boot_hal_cfg.h"
