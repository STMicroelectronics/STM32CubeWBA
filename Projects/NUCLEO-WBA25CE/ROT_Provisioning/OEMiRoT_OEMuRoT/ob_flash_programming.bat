...
set sec1_start=0x0
set sec1_end=0x39
set wrp_a_bank1_start=0x4
set wrp_a_bank1_end=0x17
...
set wrp_protect=
set remove_bank1_protect=-ob SECWM_PSTRT=0 SECWM_PEND=%flashsectnbr% WRPA_PSTRT=%flashsectnbr% WRPA_PEND=0 WRPB_PSTRT=%flashsectnbr% WRPB_PEND=0 %remove_protect_init%
...
IF "%external_flash%" == "1" (
IF "%overwrite%" == "1" (
set first_boot_stage_binary=OEMiROT_Boot_ExtFlsh_NUCLEO_WBA25CE_OVERWRITE.bin
) else (
set first_boot_stage_binary=OEMiROT_Boot_ExtFlsh_NUCLEO_WBA25CE_SWAP.bin
)
) else (
IF "%overwrite%" == "1" (
set first_boot_stage_binary=OEMiROT_Boot_NUCLEO_WBA25CE_OVERWRITE.bin
) else (
set first_boot_stage_binary=OEMiROT_Boot_NUCLEO_WBA25CE_SWAP.bin
)
)
