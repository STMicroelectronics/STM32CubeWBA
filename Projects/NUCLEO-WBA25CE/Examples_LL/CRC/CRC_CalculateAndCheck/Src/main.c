...
/**
  ...
  *          for an input data Buffer using the STM32WBAxx CRC LL API.
...
void SystemClock_Config(void)
{
  ...
  LL_RCC_PLL1_ConfigDomain_SYS(LL_RCC_PLL1SOURCE_HSE, 2, 8, 2);
...
void CheckCRCResultValue(void)
{
  ...
  {
    /* Wrong CRC value: Set LD1 to Blinking mode (Error) */
