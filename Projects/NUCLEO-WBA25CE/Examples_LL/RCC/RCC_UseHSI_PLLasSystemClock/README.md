...
set to 16MHz) and PLL with HSI as clock source (SYSCLK set to 64MHz).

LD1 will toggle differently between the 2 configurations (quick toggle with SYSCLK configuration at 64MHz).
