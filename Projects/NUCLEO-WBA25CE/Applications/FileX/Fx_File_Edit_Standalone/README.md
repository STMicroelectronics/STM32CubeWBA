...
This application provides an example of FileX stack usage on NUCLEO-WBA25CE  board, running in standalone mode (without ThreadX). It demonstrates how to create a Fat File system on the internal SRAM memory using FileX.
...
### <b>Notes</b>
 1. The created SRAM-Disk, is placed in SRAM2 (32KB) starting from the (FX_SRAM_DISK_BASE_ADDRESS=@0x20010000).
