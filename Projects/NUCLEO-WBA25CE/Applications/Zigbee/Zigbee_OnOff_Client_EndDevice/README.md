## __Zigbee_OnOff_Client_EndDevice Application Description__

How to use the OnOff cluster on a device acting as a End Device Client within a Centralized Zigbee network.
...
* One or more STM32WBA25xx board loaded with application **Zigbee_OnOff_Client_EndDevice**
</br>
...
* First, open the projects, build them and load your generated applications on your STM32WBA25xx devices.
* To run the application :
	...
	3. Start the second board. This board is configured as Zigbee EndDevice and will be attached to the network created by the coordinator.
Do the same for the other boards if applicable.  
&rarr; On EndDevice clients, blue LED will not turned on for power saving.  
...
* This example has been tested with an STMicroelectronics STM32WBA25CE_Nucleo board and can be easily tailored to any other supported device and development board.  

* On STM32WBA25CE_Nucleo, the jumpers must be configured as described in this section. Starting from the top left position up to the bottom right position, the jumpers on the Board must be set as follows:
<br>    
**JP1:**</br>
1-2:  [ON]</br>
3-4:  [OFF]</br>
