...
typedef enum _vdd_ldo_value_e {
  ...
  VDD_LDO_VALUE_LOW_POWER_OPTIMIZED  = 0x00,
...
const power_table_entry ll_tx_power_table_low_power_optimized[] = {
  {0x00, 0x03, 0x01, -20}, /* Actual_Power = -20 dBm */
  {0x00, 0x04, 0x01, -19}, /* Actual_Power = -19 dBm */
  {0x00, 0x05, 0x01, -18}, /* Actual_Power = -18 dBm */
  {0x00, 0x06, 0x01, -17}, /* Actual_Power = -17.1 dBm */
  {0x00, 0x07, 0x01, -16}, /* Actual_Power = -16.2 dBm */
  {0x00, 0x08, 0x01, -15}, /* Actual_Power = -15.2 dBm */
  {0x00, 0x09, 0x01, -14}, /* Actual_Power = -14.3 dBm */
  {0x00, 0x0A, 0x01, -13}, /* Actual_Power = -13.4 dBm */
  {0x00, 0x0B, 0x01, -12}, /* Actual_Power = -12.5 dBm */
  {0x02, 0x0C, 0x01, -11}, /* Actual_Power = -11.4 dBm */
  {0x02, 0x0D, 0x01, -10}, /* Actual_Power = -10.5 dBm */
  {0x02, 0x0E, 0x01, -9},  /* Actual_Power = -9.5 dBm */
  {0x02, 0x0F, 0x01, -8},  /* Actual_Power = -8.4 dBm */
  {0x02, 0x10, 0x01, -7},  /* Actual_Power = -7.5 dBm */
  {0x02, 0x11, 0x01, -6},  /* Actual_Power = -6.5 dBm */
  {0x00, 0x13, 0x01, -5},  /* Actual_Power = -5 dBm */
  {0x00, 0x14, 0x01, -4},  /* Actual_Power = -4.2 dBm */
  {0x00, 0x15, 0x01, -3},  /* Actual_Power = -3.2 dBm */
  {0x00, 0x16, 0x01, -2},  /* Actual_Power = -2.5 dBm */
  {0x00, 0x17, 0x01, -1},  /* Actual_Power = -1.4 dBm */
  {0x00, 0x18, 0x01, 0},   /* Actual_Power = -0.4 dBm */
  {0x02, 0x19, 0x01, 3},   /* Actual_Power = 1.4 dBm */
};
...
const power_table_id_t ll_tx_power_tables[] = {
  ...
  {ll_tx_power_table_low_power_optimized, sizeof(ll_tx_power_table_low_power_optimized)/sizeof(ll_tx_power_table_low_power_optimized[0]), VDD_LDO_VALUE_LOW_POWER_OPTIMIZED, VDD_LDO_VALUE_2_ID_0, 3},
