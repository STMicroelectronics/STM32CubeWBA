...
When a HID device is plugged to NUCLEO-WBA25CE board, a message will be displayed on the UART HyperTerminal showing
...
- NUCLEO-WBA25CE Set-up
    - Plug the USB HID device into the NUCLEO-WBA25CE board through 'Type C to A-Female' cable to the connector:
      - CN9 : to use USB DRD IP in full speed (FS)
