...
#define SAU_INIT_END4       (SYSTEM_FLASH_BASE_NS + 0x00007FFF)      /* end address of SAU region 4 */
...
//   <o.28> LPDMA_Channel0_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.29> LPDMA_Channel1_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.30> LPDMA_Channel2_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.31> LPDMA_Channel3_IRQn   <0=> Secure state <1=> Non-Secure state
*/
...
/*
// Interrupts 32..63
//   <o.0>  LPDMA_Channel4_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.1>  LPDMA_Channel5_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.2>  LPDMA_Channel6_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.3>  LPDMA_Channel7_IRQn   <0=> Secure state <1=> Non-Secure state
//   <o.4>  OTFDEC1_IRQn          <0=> Secure state <1=> Non-Secure state
//   <o.8>  TIM2_IRQn             <0=> Secure state <1=> Non-Secure state
//   <o.9>  I2C1_EV_IRQn          <0=> Secure state <1=> Non-Secure state
//   <o.10> I2C1_ER_IRQn          <0=> Secure state <1=> Non-Secure state
//   <o.11> USART1_IRQn           <0=> Secure state <1=> Non-Secure state
//   <o.12> LPUART1_IRQn          <0=> Secure state <1=> Non-Secure state
//   <o.13> LPTIM1_IRQn           <0=> Secure state <1=> Non-Secure state
//   <o.14> LPTIM2_IRQn           <0=> Secure state <1=> Non-Secure state
//   <o.15> TIM16_IRQn            <0=> Secure state <1=> Non-Secure state
//   <o.16> TIM17_IRQn            <0=> Secure state <1=> Non-Secure state
//   <o.17> I2C3_EV_IRQn          <0=> Secure state <1=> Non-Secure state
//   <o.18> I2C3_ER_IRQn          <0=> Secure state <1=> Non-Secure state
//   <o.19> SAI1_IRQn             <0=> Secure state <1=> Non-Secure state
//   <o.20> AES_IRQn              <0=> Secure state <1=> Non-Secure state
//   <o.21> RNG_IRQn              <0=> Secure state <1=> Non-Secure state
//   <o.22> FPU_IRQn              <0=> Secure state <1=> Non-Secure state
//   <o.23> HASH_IRQn             <0=> Secure state <1=> Non-Secure state
//   <o.24> PKA_IRQn              <0=> Secure state <1=> Non-Secure state
//   <o.25> SPI3_IRQn             <0=> Secure state <1=> Non-Secure state
//   <o.26> ICACHE_IRQn           <0=> Secure state <1=> Non-Secure state
//   <o.27> ADC4_IRQn             <0=> Secure state <1=> Non-Secure state
//   <o.28> RADIO_IRQn            <0=> Secure state <1=> Non-Secure state
//   <o.29> WKUP_IRQn             <0=> Secure state <1=> Non-Secure state
//   <o.30> WKUP_S_IRQn           <0=> Secure state <1=> Non-Secure state
//   <o.31> RCC_AUDIOSYNC_IRQn    <0=> Secure state <1=> Non-Secure state
*/
...
/*
// Interrupts 64..95
//   <o.0>  USB_IRQn              <0=> Secure state <1=> Non-Secure state
//   <o.1>  XSPI1_IRQn            <0=> Secure state <1=> Non-Secure state
//   <o.2>  EXTI19_RADIO_IO_IRQn  <0=> Secure state <1=> Non-Secure state
//   <o.3>  EXTI20_RADIO_IO_IRQn  <0=> Secure state <1=> Non-Secure state
*/
