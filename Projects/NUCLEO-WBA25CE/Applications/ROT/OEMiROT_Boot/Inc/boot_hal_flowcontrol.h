...
#else
#define FLOW_STEP_MPU_S_I_EN_R3     0x00000000U        /*!< Step MPU Secure Region 3 Init enable value */
...
#else
#define FLOW_STEP_MPU_S_I_CH_R3     0x00000000U        /*!< Step MPU Secure Region 3 Init check value */
#endif /* (MCUBOOT_S_DATA_IMAGE_NUMBER == 1) */
...
#define FLOW_STEP_PWR_L_EN          0x00018667U        /*!< Step fast wake-up enable value */
#define FLOW_STEP_PWR_L_CH          0x000793f4U        /*!< Step fast wake-up check value */
#else
#define FLOW_STEP_PWR_L_EN          0x00000000U        /*!< No effect on control flow */
#define FLOW_STEP_PWR_L_CH          0x00000000U        /*!< No effect on control flow */
...
#define FLOW_CTRL_MPU_S_I_EN        (FLOW_CTRL_MPU_S_I_EN_R7 ^   FLOW_STEP_MPU_S_I_EN)

#define FLOW_CTRL_SAU_I_EN_R0       (FLOW_CTRL_MPU_S_I_EN ^      FLOW_STEP_SAU_I_EN_R0)
...
#define FLOW_CTRL_MPU_S_I_CH        (FLOW_CTRL_MPU_S_I_CH_R7 ^   FLOW_STEP_MPU_S_I_CH)

#define FLOW_CTRL_SAU_I_CH_R0       (FLOW_CTRL_MPU_S_I_CH ^      FLOW_STEP_SAU_I_CH_R0)
...
#define FLOW_CTRL_STAGE_3_A         FLOW_CTRL_MPU_S_A_EN_R0

/* Flow control Stage 4 Appli */
#define FLOW_CTRL_MPU_S_A_CH_R0     (FLOW_CTRL_STAGE_3_A ^       FLOW_STEP_MPU_S_A_CH_R0)

#define FLOW_CTRL_STAGE_4_A         FLOW_CTRL_MPU_S_A_CH_R0
...
#define FLOW_CTRL_SAU_L_EN_R0       (FLOW_CTRL_STAGE_4_L  ^   FLOW_STEP_SAU_L_EN_R0)
...
#define FLOW_CTRL_PWR_L_EN          (FLOW_CTRL_SAU_L_EN ^        FLOW_STEP_PWR_L_EN)

#define FLOW_CTRL_STAGE_5_L         FLOW_CTRL_PWR_L_EN

/* Flow control Stage 6 Loader */

#define FLOW_CTRL_SAU_L_CH_R0       (FLOW_CTRL_STAGE_5_L ^   FLOW_STEP_SAU_L_CH_R0)
...
#define FLOW_CTRL_PWR_L_CH          (FLOW_CTRL_SAU_L_CH ^        FLOW_STEP_PWR_L_CH)

#define FLOW_CTRL_STAGE_6_L         FLOW_CTRL_PWR_L_CH
