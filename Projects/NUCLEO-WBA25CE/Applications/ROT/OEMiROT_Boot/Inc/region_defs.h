...
/* External XSPI Flash base addresses - Non secure and secure aliased */
#define _EXT_FLASH_BASE        (EXT_FLASH_BASE_ADDRESS) /*!< XSPI FLASH(up to 64 MB) base address */
#endif /* OEMIROT_EXTERNAL_FLASH_ENABLE */
#define _SRAM1_SIZE_MAX         (0x10000)  /*!< SRAM1=64k*/
#define _SRAM2_SIZE_MAX         (0x8000)  /*!< SRAM2=32k*/
...
#define _SRAM2_BASE_NS          (0x20010000) /*!< SRAM2(32 KB) base address */
...
#define _SRAM2_BASE_S           (0x30010000) /*!< SRAM2(32 KB) base address */
