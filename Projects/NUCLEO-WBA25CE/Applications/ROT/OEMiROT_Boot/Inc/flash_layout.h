...
/*#define OEMIROT_EXTERNAL_FLASH_ENABLE*/   /* Defined: External XSPI flash used for all secondary slots.
                                               Undefined: External XSPI flash not used. */
...
#define FLASH_TOTAL_SIZE                (FLASH_B_SIZE + FLASH_B_SIZE) /* 512 KB */
#define FLASH_BASE_ADDRESS              (0x0C000000)

#if  defined(OEMIROT_EXTERNAL_FLASH_ENABLE)
/* External XSPI Flash layout info for BL2 bootloader */
#define EXT_FLASH_TOTAL_SIZE           (0x400000)  /* 32 Mbits => 4MBytes */
#define EXT_FLASH_BASE_ADDRESS         (0x90000000)
#define EXT_FLASH_BASE_OFFSET          (0x00000000)

/* Flash device ID */
#define EXT_FLASH_DEVICE_ID            (FLASH_DEVICE_ID + 1) /* XSPI Flash */
#endif /* OEMIROT_EXTERNAL_FLASH_ENABLE */
...
#define OEMIROT_AREA_1_SIZE             (0x30000)       /* 192K */
#else
#define OEMIROT_AREA_1_SIZE             (0x38000)       /* 224K */
#endif
#define OEMIROT_AREA_2_SIZE             (0x14000)       /* 80K */
#if defined (OEMIROT_EXTERNAL_FLASH_ENABLE)
#define OEMIROT_AREA_2_OFFSET           (0x3EA000)      /* slot 2 address when external flash size: 4 MBytes */
#else
...
#if defined(OEMUROT_ENABLE)
/* area for BL2 code protected by hdp */
#define FLASH_AREA_BL2_HDP_END_OFFSET     (FLASH_AREA_BL2_OFFSET + FLASH_AREA_BL2_SIZE + BL2_HEADER_SIZE + FLASH_AREA_IMAGE_SECTOR_SIZE + FLASH_AREA_IMAGE_SECTOR_SIZE)
/* HDP area end at this address */
#define FLASH_BL2_HDP_END                 (FLASH_AREA_BL2_HDP_END_OFFSET -1)
#else /* OEMUROT_ENABLE */
/* area for BL2 code protected by hdp */
#define FLASH_AREA_BL2_HDP_END_OFFSET     (FLASH_AREA_BL2_OFFSET + FLASH_AREA_BL2_SIZE + FLASH_AREA_IMAGE_SECTOR_SIZE + FLASH_AREA_IMAGE_SECTOR_SIZE)
/* HDP area end at this address */
#define FLASH_BL2_HDP_END                 (FLASH_AREA_BL2_HDP_END_OFFSET -1)
#endif /* OEMUROT_ENABLE */
/* control area for BL2 code protected by hdp */
#if (FLASH_AREA_BL2_HDP_END_OFFSET % FLASH_AREA_IMAGE_SECTOR_SIZE) != 0
#error "HDP area must be aligned on FLASH_AREA_IMAGE_SECTOR_SIZE"
#endif /* (FLASH_AREA_BL2_HDP_END_OFFSET % FLASH_AREA_IMAGE_SECTOR_SIZE) != 0 */
...
#define FLASH_OTP_NV_COUNTERS_AREA_OFFSET (FLASH_AREA_BL2_HDP_END_OFFSET)
...
#if  defined(OEMIROT_FIRST_BOOT_STAGE)
/* For OEMIROT_FIRST_BOOT_STAGE we need 80K KB for S partition (FLASH_AREA_BL2_SIZE + FLASH_AREA_IMAGE_SECTOR_SIZE + FLASH_AREA_IMAGE_SECTOR_SIZE) */
...
#define FLASH_S_PARTITION_SIZE          (0x9000)
...
#define OEMUROT_SCRATCH_SIZE            (0x8000) /* 32 KB */
#else
#define OEMUROT_SCRATCH_SIZE            (0x0) /* Not used in MCUBOOT_OVERWRITE_ONLY mode */
#endif /* MCUBOOT_OVERWRITE_ONLY */

#define OEMUROT_PERSO_SIZE              (0x2000)
#define FLASH_AREA_BEGIN_OFFSET         (FLASH_AREA_BL2_HDP_END_OFFSET + \
                                         OEMUROT_HASH_REF_SIZE + OEMUROT_BL2_NVCNT_SIZE + \
                                         OEMUROT_SCRATCH_SIZE + OEMUROT_PERSO_SIZE)
#else /* OEMIROT_FIRST_BOOT_STAGE */
#define OEMIROT_AREA_0_OFFSET           (OEMIROT_AREA_BEGIN_OFFSET + (FLASH_AREA_IMAGE_SECTOR_SIZE + FLASH_AREA_IMAGE_SECTOR_SIZE +\
                                                                      FLASH_AREA_IMAGE_SECTOR_SIZE + FLASH_AREA_IMAGE_SECTOR_SIZE +\
                                                                      FLASH_AREA_IMAGE_SECTOR_SIZE + FLASH_AREA_IMAGE_SECTOR_SIZE) + FLASH_AREA_SCRATCH_SIZE)
#if defined (OEMUROT_ENABLE)
#define FLASH_AREA_BEGIN_OFFSET         (FLASH_AREA_BL2_HDP_END_OFFSET + BL2_TRAILER_SIZE)
#else /* OEMUROT_ENABLE */
#if defined(TFM_COMPATIBILTY)
...
#define FLASH_DEV_NAME_2                 EXT_FLASH_DEV_NAME
#define FLASH_DEVICE_ID_2               (EXT_FLASH_DEVICE_ID)
#define FLASH_AREA_2_OFFSET             (EXT_FLASH_BASE_OFFSET)
#if (MCUBOOT_APP_IMAGE_NUMBER == 2)
...
#if defined(OEMIROT_EXTERNAL_FLASH_ENABLE)
#define FLASH_DEV_NAME_3                 EXT_FLASH_DEV_NAME
#define FLASH_DEVICE_ID_3               (EXT_FLASH_DEVICE_ID)
#define FLASH_AREA_3_OFFSET             (EXT_FLASH_BASE_OFFSET + FLASH_AREA_2_SIZE)
...
#if defined(OEMIROT_EXTERNAL_FLASH_ENABLE)
#define FLASH_DEV_NAME_6                 EXT_FLASH_DEV_NAME
#define FLASH_DEVICE_ID_6               (EXT_FLASH_DEVICE_ID)
#define FLASH_AREA_6_OFFSET             (EXT_FLASH_BASE_OFFSET + FLASH_AREA_2_SIZE + \
                                         FLASH_AREA_3_SIZE)
...
#if defined(OEMIROT_EXTERNAL_FLASH_ENABLE)
#define FLASH_DEV_NAME_7                 EXT_FLASH_DEV_NAME
#define FLASH_DEVICE_ID_7               (EXT_FLASH_DEVICE_ID)
#define FLASH_AREA_7_OFFSET             (EXT_FLASH_BASE_OFFSET + FLASH_AREA_2_SIZE + \
...
/* MPU config */
#define RSS_LIB_BASE                    (0x0FF84000U)
#define RSS_LIB_SIZE                    (0x1000U)

/* SAU config */
#define STM32_DESCRIPTOR_BASE_NS        RSSLIB_SYS_FLASH_NS_PFUNC_START
#define STM32_DESCRIPTOR_END_NS         RSSLIB_SYS_FLASH_NS_PFUNC_END
