...
/* area for flashing images */
  ...
  RE_IMAGE_FLASH_SECURE_UPDATE = (EXT_FLASH_BASE_ADDRESS + FLASH_AREA_2_OFFSET),
  RE_IMAGE_FLASH_NON_SECURE_UPDATE = (EXT_FLASH_BASE_ADDRESS + FLASH_AREA_3_OFFSET),
  RE_PRIMARY_ONLY = (0x0),
#else
  ...
  RE_BL2_WRP_END = (FLASH_AREA_BL2_HDP_END_OFFSET - 0x1),
#endif /* OEMUROT_ENABLE */
#if defined (OEMUROT_ENABLE)
  /* HASH reference area offset marks the start of the second boot stage (uRoT)
   * and the end boundary of the HDP coverage area for the first boot stage.
   * At the end of the second boot stage uRoT execution, this stage will be covered by the HDP extension.
   */
  RE_BL2_HDP_END = (FLASH_HASH_REF_AREA_OFFSET - 0x1),
#else
  RE_BL2_HDP_END = (FLASH_AREA_BL2_HDP_END_OFFSET - 0x1),
#endif /* OEMUROT_ENABLE */
