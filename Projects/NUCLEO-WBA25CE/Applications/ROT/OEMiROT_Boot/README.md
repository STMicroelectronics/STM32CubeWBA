...
It is needed to connect TAMP_IN4 (PC13 on CN4 pin 36) to VCC on the NUCLEO-WBA25CE board and reset the board to trigger a tamper event.
...
For NUCLEO-WBA25CE devices, with all IDE's, the are the following limitation:
