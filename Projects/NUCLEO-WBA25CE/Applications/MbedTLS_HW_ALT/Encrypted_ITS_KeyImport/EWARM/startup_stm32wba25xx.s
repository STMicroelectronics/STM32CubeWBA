;********************************************************************************
;* File Name          : startup_stm32wba25xx.s
;* Author             : MCD Application Team
;* Description        : STM32WBA2xx Ultra Low Power Devices vector
...
__vector_table
        ...
        DCD     LPDMA1_Channel0_IRQHandler       ; LPDMA1 Channel 0 global interrupt
        DCD     LPDMA1_Channel1_IRQHandler       ; LPDMA1 Channel 1 global interrupt
        DCD     LPDMA1_Channel2_IRQHandler       ; LPDMA1 Channel 2 global interrupt
        DCD     LPDMA1_Channel3_IRQHandler       ; LPDMA1 Channel 3 global interrupt
        DCD     LPDMA1_Channel4_IRQHandler       ; LPDMA1 Channel 4 global interrupt
        DCD     LPDMA1_Channel5_IRQHandler       ; LPDMA1 Channel 5 global interrupt
        DCD     LPDMA1_Channel6_IRQHandler       ; LPDMA1 Channel 6 global interrupt
        DCD     LPDMA1_Channel7_IRQHandler       ; LPDMA1 Channel 7 global interrupt
        ...
        DCD     USB_DRD_FS_IRQHandler            ; USB Dual Role Device global interrupt
        DCD     XSPI1_IRQHandler                 ; XSPI1 global interrupt
        DCD     EXTI19_RADIO_IO_IRQHandler       ; EXTI line 19 interrupt, 2.4 GHz RADIO io[x]
        DCD     EXTI20_RADIO_IO_IRQHandler       ; EXTI line 20 interrupt, 2.4 GHz RADIO io[y]
...
LPDMA1_Channel3_IRQHandler
        ...
        PUBWEAK LPDMA1_Channel4_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
LPDMA1_Channel4_IRQHandler
        B LPDMA1_Channel4_IRQHandler

        PUBWEAK LPDMA1_Channel5_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
LPDMA1_Channel5_IRQHandler
        B LPDMA1_Channel5_IRQHandler

        PUBWEAK LPDMA1_Channel6_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
LPDMA1_Channel6_IRQHandler
        B LPDMA1_Channel6_IRQHandler

        PUBWEAK LPDMA1_Channel7_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
LPDMA1_Channel7_IRQHandler
        B LPDMA1_Channel7_IRQHandler
...
XSPI1_IRQHandler
        ...
        PUBWEAK EXTI19_RADIO_IO_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
EXTI19_RADIO_IO_IRQHandler
        B EXTI19_RADIO_IO_IRQHandler

        PUBWEAK EXTI20_RADIO_IO_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
EXTI20_RADIO_IO_IRQHandler
        B EXTI20_RADIO_IO_IRQHandler
