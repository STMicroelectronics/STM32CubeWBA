...
- the SystemInit() function in secure application sets up the SAU/IDAU, FPU and secure/non-secure interrupts allocations defined in partition_stm32wbaxx.h file.
...
Please note that the internal Flash is fully secure by default in TZEN=1 and User Option Bytes SECWM1_PSTRT/SECWM1_PEND/SECWM2_PSTRT/SECWM2_PEND
...
### <b>Hardware and Software environment</b>
  ...
  - This application runs on STM32WBA25xx devices with security enabled (TZEN=1).

  - This application has been tested with STMicroelectronics NUCLEO-WBA25CE1 revision boards MB2293-WBA2-B01
