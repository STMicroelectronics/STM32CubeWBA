 ...
 */
#define CFG_BD_ADDRESS_TYPE               (GAP_RESOLVABLE_PRIVATE_ADDR)

/**
 * Maximum number of Client contexts (one for each connected Server)
 */
...
#define APPLI_CONFIG_LOG_REGION     (1U << LOG_REGION_APP)
...
typedef enum
{
  ...
  CFG_TASK_CENTRAL_CONN_INTERV_UPDATE_SERV_DISCO_ID,
...
typedef enum
{
  ...
  CFG_EVENT_PROC_GATT_COMPLETE,
  /* USER CODE BEGIN CFG_Event_Id_t */
  CFG_EVENT_CONNECTION_COMPLETE,
