...
static char a_GapDeviceName[] = {  'H', 'e', 'a', 'l', 't', 'h', 'T', 'h', 'e', 'r', 'm', 'o', 'm', 'e', 't', 'e', 'r', ' ', 'S', 'e', 'n', 's', 'o', 'r' }; /* Gap Device Name */
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          HTSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          HTSHandleNotification.EvtOpcode = HTS_CONN_HANDLE_EVT;
          DISHandleNotification.EvtOpcode = DIS_CONN_HANDLE_EVT;
          HTSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
...
/* Add number of record for Device Info Characteristic */
  ...
  */
  ...
  a_GATT_DevInfoData[11] = FW_ID_HEALTH_THERMO;
