...
#define CFG_BLE_COC_INITIATOR_NBR_MAX (5)
...
typedef enum
{
  ...
  CFG_TASK_ESL_AP_SAVE_KEY,
  CFG_TASK_NVMDB_PROCESS,
...
typedef enum
{
  ...
  CFG_EVENT_FM_CALLBACK_EVT_RSP_ID,
  CFG_EVENT_READ_REMOTE_FEATURES_COMPLETE,
  CFG_EVENT_OTP,
