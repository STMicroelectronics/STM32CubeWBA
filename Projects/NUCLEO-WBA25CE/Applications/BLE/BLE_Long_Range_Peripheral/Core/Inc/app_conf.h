...
#define CFG_PHY_PREF_TX               (HCI_TX_PHYS_LE_1M_PREF | HCI_TX_PHYS_LE_2M_PREF | HCI_TX_PHYS_LE_CODED_PREF)
#define CFG_PHY_PREF_RX               (HCI_RX_PHYS_LE_1M_PREF | HCI_RX_PHYS_LE_2M_PREF | HCI_RX_PHYS_LE_CODED_PREF)
