...
#define CFG_USER_DATA_SECTORS_NB                (2)
#else
#define CFG_USER_DATA_SECTORS_NB                (1)
#endif /* STM32WBA25xx */   
 ...
 */
#if defined(STM32WBA25xx)
#define CFG_ACTIVE_SLOT_START_SECTOR_INDEX      (6)
#else
 ...
 */
#define CFG_BLE_NUM_GATT_SERVICES   (5)
 ...
 */
#define CFG_BLE_HOST_EVENT_BUF_SIZE   (1024)
 ...
 */
#define CFG_LPM_STDBY_WAKEUP_TIME (2000U)
