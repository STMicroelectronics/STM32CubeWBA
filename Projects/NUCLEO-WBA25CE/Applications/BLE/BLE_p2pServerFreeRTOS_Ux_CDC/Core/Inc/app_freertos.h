...
extern osThreadId_t P2PAPPCmdTaskHandle;
extern osThreadId_t BLEInitTaskHandle;
extern osTimerId_t advLowPowerTimerHandle;
extern osTimerId_t switchOffGPIOTimerHandle;
extern osMessageQueueId_t advertisingCmdQueueHandle;
extern osMessageQueueId_t BLEInitCmdQueueHandle;
extern osSemaphoreId_t P2PAPPSemaphoreHandle;
