...
/**
* @brief  Init the USBX stack.
* @param  cb tx function callback.
* @return @ref UTIL_ADV_TRACE_Status_t
*/
UTIL_ADV_TRACE_Status_t USBX_If_Init(void (*cb)(void *));

/**
* @brief  DeInit the USBX stack.
* @return @ref UTIL_ADV_TRACE_Status_t
*/
UTIL_ADV_TRACE_Status_t USBX_If_Deinit(void);

/**
* @brief  send buffer to USBX stack
* @param  pdata data to be sent
* @param  size of buffer p_data to be sent
* @return @ref UTIL_ADV_TRACE_Status_t
*/
UTIL_ADV_TRACE_Status_t USBX_If_Transmit(uint8_t *pdata, uint16_t size);
...
* @return @ref UTIL_ADV_TRACE_Status_t
*/
UTIL_ADV_TRACE_Status_t USBX_If_StartRx(void (*cb)(uint8_t *pdata, uint16_t size, uint8_t error));
