...
static void EddystoneTLM(void)
{
  ...
  { /* Advertising of TLM */
    ...
    ret = hci_le_set_advertising_data(sizeof(TLM_data), TLM_data);
  ...
  else
  {
    ...
    /* Update the service data. */
    ret = hci_le_set_advertising_data(sizeof(UID_data), UID_data);
    ...
    /* Update the service data. */
    ret = hci_le_set_advertising_data(sizeof(URL_data), URL_data);
