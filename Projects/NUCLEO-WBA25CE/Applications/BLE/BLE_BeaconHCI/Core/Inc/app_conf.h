 ...
 */
#define CFG_BLE_OPTIONS             (BLE_OPTIONS_LL_ONLY | \
                                     0 | \
                                     0 | \
                                     0 | \
 ...
 */
#define CFG_BLE_ATT_VALUE_ARRAY_SIZE  (0)
 ...
 */
#define CFG_BLE_ATTR_PREPARE_WRITE_VALUE_SIZE       (0)

#define CFG_BLE_MBLOCK_COUNT_MARGIN                 (0x00)
