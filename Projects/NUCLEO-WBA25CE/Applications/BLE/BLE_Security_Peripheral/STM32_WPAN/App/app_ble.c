...
SECURITY_SERVER_APP_ConnHandleNotEvt_t SECURITY_SERVERHandleNotification;
...
{
  10, AD_TYPE_COMPLETE_LOCAL_NAME, 'S', 'E', 'C', 'U', 'R', 'I', '_', 'X', 'X',  /* Complete name */
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      SECURITY_SERVERHandleNotification.EvtOpcode = SECURITY_SERVER_DISCON_HANDLE_EVT;
      SECURITY_SERVERHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      SECURITY_SERVER_APP_EvtRx(&SECURITY_SERVERHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          SECURITY_SERVERHandleNotification.EvtOpcode = SECURITY_SERVER_CONN_HANDLE_EVT;
          SECURITY_SERVERHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          SECURITY_SERVER_APP_EvtRx(&SECURITY_SERVERHandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          SECURITY_SERVERHandleNotification.EvtOpcode = SECURITY_SERVER_CONN_HANDLE_EVT;
          SECURITY_SERVERHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          SECURITY_SERVER_APP_EvtRx(&SECURITY_SERVERHandleNotification);
...
/* Add number of record for Device Info Characteristic */
  ...
  */
  ...
  a_GATT_DevInfoData[11] = FW_ID_SECURITY;
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_SECURITY; /* FW ID */
