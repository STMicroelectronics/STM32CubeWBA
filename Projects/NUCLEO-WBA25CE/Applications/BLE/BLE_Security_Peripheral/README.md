...
Demonstrate STM32WBA2 acting as BLE peripheral and GATT server.

BLE_Security_Peripheral application advertises and waits for a connection from either:
- BLE_Security_Central application running on STM32WBA2 device
...
### __Hardware and Software environment__
  ...
  - Another STM32WBA2 Nucleo board may be necessary to run BLE_Security_Central application.
