...
#define ADV_Size                           20        /*ADV Size Can be between [1..31] or [5..31] if Local Name is used */

#define NOTIFY_TX_INT_MS                   1000      /*Notification Packet interval*/ 
#define USER_PAYLOAD_LENGTH                20        /*User_Payload_Length must be between 1 and 244*/
#define Setup_Time                         10000     /*Timer before all GPIOs are disabled and clocks off*/ 

#define CONN_INT_REQ                       50        /*L2cap Connection Interval Request*/
#define CONN_INT_LP_REQ                    200 

#define ADV_TYPE_2                        ADV_NONCONN_IND
...
#define ADV_INTERVAL_MAX                  (80)
#define ADV_LP_INTERVAL_MIN               (1280)
#define ADV_LP_INTERVAL_MAX               (1280)
...
#define CFG_SNVMA_START_SECTOR_ID     ((FLASH_SIZE / FLASH_PAGE_SIZE) - 4u)
 ...
 */
#define CFG_RF_TX_POWER_TABLE_ID            (3)
