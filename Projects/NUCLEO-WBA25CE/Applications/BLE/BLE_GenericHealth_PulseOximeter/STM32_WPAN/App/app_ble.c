...
#define COPY_DEVINFO_UUID(uuid_struct)       COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x31,0x8e,0x22,0x45,0x41,0x9e,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
/* USER CODE END PD */
...
GHS_APP_ConnHandleNotEvt_t GHSHandleNotification;
DIS_APP_ConnHandleNotEvt_t DISHandleNotification;
ETS_APP_ConnHandleNotEvt_t ETSHandleNotification;

static char a_GapDeviceName[] = {  'G', 'e', 'n', 'e', 'r', 'i', 'c', ' ', 'H', 'e', 'a', 'l', 't', 'h', ' ', 'S', 'e', 'n', 's', 'o', 'r', ' ', 'E', 'l', 'e', 'c', 't', 'r', 'o', 'C', 'a', 'r', 'd', 'i', 'o', 'G', 'r', 'a', 'm', ' ' }; /* Gap Device Name */

/* Advertising Data */
uint8_t a_AdvData[27] =
{
  6, AD_TYPE_COMPLETE_LOCAL_NAME, 'P', 'O', '_', 'X', 'X',  /* Complete name */
  3, AD_TYPE_16_BIT_SERV_UUID_CMPLT_LIST, 0x40, 0x18,
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      GHSHandleNotification.EvtOpcode = GHS_DISCON_HANDLE_EVT;
      DISHandleNotification.EvtOpcode = DIS_DISCON_HANDLE_EVT;
      ETSHandleNotification.EvtOpcode = ETS_DISCON_HANDLE_EVT;
      GHSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      DISHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      ETSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      GHS_APP_EvtRx(&GHSHandleNotification);
      DIS_APP_EvtRx(&DISHandleNotification);
      ETS_APP_EvtRx(&ETSHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        case HCI_LE_CONNECTION_UPDATE_COMPLETE_SUBEVT_CODE:
        {
          ...
          currentGapParam.MinConInt = p_conn_update_complete->Conn_Interval;
          currentGapParam.MaxConInt = p_conn_update_complete->Conn_Interval;
          currentGapParam.Latency   = p_conn_update_complete->Conn_Latency;
          currentGapParam.SupervisionTimeoutMultiplier = p_conn_update_complete->Supervision_Timeout;
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          GHSHandleNotification.EvtOpcode = GHS_CONN_HANDLE_EVT;
          DISHandleNotification.EvtOpcode = DIS_CONN_HANDLE_EVT;
          ETSHandleNotification.EvtOpcode = ETS_CONN_HANDLE_EVT;
          GHSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          DISHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          ETSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          GHS_APP_EvtRx(&GHSHandleNotification);
          DIS_APP_EvtRx(&DISHandleNotification);
          ETS_APP_EvtRx(&ETSHandleNotification);
          /* USER CODE BEGIN HCI_EVT_LE_ENHANCED_CONN_COMPLETE */
          currentGapParam.MinConInt = p_enhanced_conn_complete->Conn_Interval;
          currentGapParam.MaxConInt = p_enhanced_conn_complete->Conn_Interval;
          currentGapParam.Latency   = p_enhanced_conn_complete->Conn_Latency;
          currentGapParam.SupervisionTimeoutMultiplier = p_enhanced_conn_complete->Supervision_Timeout;
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          DISHandleNotification.EvtOpcode = DIS_CONN_HANDLE_EVT;
          ETSHandleNotification.EvtOpcode = ETS_CONN_HANDLE_EVT;
          GHSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          DISHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          ETSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          GHS_APP_EvtRx(&GHSHandleNotification);
          DIS_APP_EvtRx(&DISHandleNotification);
          ETS_APP_EvtRx(&ETSHandleNotification);
          /* USER CODE BEGIN HCI_EVT_LE_CONN_COMPLETE */
          UTIL_TIMER_Stop(&(bleAppContext.TimerAdvLowPower_Id));
          currentGapParam.MinConInt = p_conn_complete->Conn_Interval;
          currentGapParam.MaxConInt = p_conn_complete->Conn_Interval;
          currentGapParam.Latency   = p_conn_complete->Conn_Latency;
          currentGapParam.SupervisionTimeoutMultiplier = p_conn_complete->Supervision_Timeout;
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
    {
      ...
      switch (p_blecore_evt->ecode)
      {
        ...
        case ACI_L2CAP_CONNECTION_UPDATE_RESP_VSEVT_CODE:
        {
          ...
          UTIL_SEQ_SetEvt(1 << CFG_EVENT_GAP_UPDATE_CONNECTION_COMPLETE);
...
void APP_BLE_Procedure_Gap_Peripheral(ProcGapPeripheralId_t ProcGapPeripheralId)
{
  ...
  /* Save parameters for Reconnection Configuration Service */
  switch(ProcGapPeripheralId)
  {
    case PROC_GAP_PERIPH_ADVERTISE_START_FAST:
    case PROC_GAP_PERIPH_ADVERTISE_START_LP:
    ...
    case PROC_GAP_PERIPH_ADVERTISE_NON_CONN_START_LP:
    {
      currentGapParam.AdvInt = paramA;
      break;
    }
    case PROC_GAP_PERIPH_CONN_PARAM_UPDATE:
    {
      currentGapParam.MinConInt = paramA;
      currentGapParam.MaxConInt = paramB;
      break;
    }
    default:
      break;
...
/* Add number of record for Device Info Characteristic */
  ...
  */
  ...
  a_GATT_DevInfoData[11] = FW_ID_GENERIC_HEALTH_SENSOR;
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_GENERIC_HEALTH_SENSOR; /* FW ID */
