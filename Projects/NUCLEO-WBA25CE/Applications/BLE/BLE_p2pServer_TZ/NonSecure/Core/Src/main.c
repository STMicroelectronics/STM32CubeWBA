...
void MX_USART1_UART_Init(void)
{
  ...
  /* workaround since LPDMA is not yet available for WBA2 TODO to remove */
  huart1.hdmatx = (DMA_HandleTypeDef*)0x20000000;
  huart1.hdmarx = (DMA_HandleTypeDef*)0x20000000;
