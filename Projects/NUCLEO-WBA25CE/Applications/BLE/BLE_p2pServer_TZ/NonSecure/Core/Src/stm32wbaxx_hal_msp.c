...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  if(huart->Instance==USART1)
  {
    ...
    */
    ...
    if (HAL_DMA_ConfigChannelAttributes(&handle_LPDMA1_Channel0, DMA_CHANNEL_NPRIV|DMA_CHANNEL_NSEC
    ...
    if (HAL_DMA_ConfigChannelAttributes(&handle_LPDMA1_Channel1, DMA_CHANNEL_NPRIV|DMA_CHANNEL_NSEC
                              |DMA_CHANNEL_SRC_NSEC|DMA_CHANNEL_DEST_NSEC) != HAL_OK)
    {
      Error_Handler();
    }
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PA12     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_6|GPIO_PIN_12);
