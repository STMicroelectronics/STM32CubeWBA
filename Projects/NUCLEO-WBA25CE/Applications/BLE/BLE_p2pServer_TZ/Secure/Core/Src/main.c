...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_ConfigPinAttributes(GPIOA, GPIO_PIN_6|GPIO_PIN_14|GPIO_PIN_13|GPIO_PIN_12, GPIO_PIN_NSEC);

  /* USER CODE BEGIN MX_GPIO_Init_2 */
  /* LED 2,3 NSEC configuration */
  __HAL_RCC_GPIOB_CLK_ENABLE();
  HAL_GPIO_ConfigPinAttributes(GPIOB, GPIO_PIN_12 | GPIO_PIN_15, GPIO_PIN_NSEC);
  /* Button 1,2,3 NSEC configuration */
  HAL_GPIO_ConfigPinAttributes(GPIOA, GPIO_PIN_1 | GPIO_PIN_2, GPIO_PIN_NSEC);
...
void MPU_Config(void)
{
  ...
  */
  ...
  MPU_InitStruct.LimitAddress = 0x0C0FFFFF;
