...
void EXTI5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(TM_SPI_CS_Pin);
...
/**
  * @brief This function handles LPDMA1 Channel 1 global interrupt.
  */
...
/**
  * @brief This function handles LPDMA1 Channel 3 global interrupt.
  */
void LPDMA1_Channel3_IRQHandler(void)
{
  /* USER CODE BEGIN LPDMA1_Channel3_IRQn 0 */

  /* USER CODE END LPDMA1_Channel3_IRQn 0 */
  HAL_DMA_IRQHandler(&handle_LPDMA1_Channel3);
  /* USER CODE BEGIN LPDMA1_Channel3_IRQn 1 */

  /* USER CODE END LPDMA1_Channel3_IRQn 1 */
}
...
/**
  * @brief This function handles PWR non-secure global WKUP pin interrupt.
  */
