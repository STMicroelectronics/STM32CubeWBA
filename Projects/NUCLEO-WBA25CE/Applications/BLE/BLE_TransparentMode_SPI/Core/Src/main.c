...
static void SystemPower_Config(void)
{
  ...
  HAL_NVIC_SetPriority(WKUP_IRQn, 4, 0);
...
void MX_LPDMA1_Init(void)
{
  ...
  /* LPDMA1 interrupt Init */
    ...
    HAL_NVIC_SetPriority(LPDMA1_Channel3_IRQn, 3, 0);
...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : TM_SPI_CS_Pin */
  GPIO_InitStruct.Pin = TM_SPI_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(TM_SPI_CS_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : TM_SPI_IRQ_Pin */
