...
- high threshold is set to Vref+/2 (3.3V/2=1.65V on NUCLEO-WBA25CE), refer to literal ADC_AWD_THRESHOLD_HIGH.
...
Other peripherals used:
  ...
  1 GPIO for analog input: ADC channel 3 on pin PA.06 (Morpho pin 37 CN3)
