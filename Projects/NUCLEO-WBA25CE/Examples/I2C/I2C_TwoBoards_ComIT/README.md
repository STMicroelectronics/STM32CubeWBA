...
using an interrupt.
       ...
       - SCL Pin: PB2 (CN6, pin10)
       - SDA Pin: PA11 (CN6, pin9)
...
NUCLEO-WBA25CE's LEDs can be used to monitor the transfer status:
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-WBA25CE Set-up
    ...
    - Connect I2C_SCL line of Master board (PB2, CN6, pin10) to I2C_SCL line of Slave Board (PB2, CN6, pin10).
    - Connect I2C_SDA line of Master board (PA11, CN6, pin9) to I2C_SDA line of Slave Board (PA11, CN6, pin9).
