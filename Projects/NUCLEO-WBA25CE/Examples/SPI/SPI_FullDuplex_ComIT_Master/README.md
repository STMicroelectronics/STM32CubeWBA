...
Data buffer transmission/reception between two boards via SPI using Interrupt mode.
	...
	Board: NUCLEO-WBA25CE (embeds a STM32WBA25CEUx device)
	CLK Pin: PA8 (CN6, pin 6)
	MISO Pin: PA10 (CN6, pin 5)
	MOSI Pin: PA9 (CN6, pin 4)
   _________________________                       __________________________
  |           ______________|                      |______________           |
  |          |SPI3          |                      |          SPI3|          |
  |          |              |                      |              |          |
  |          |    CLK(PA.08)|______________________|CLK(PA.08)    |          |
  |          |              |                      |              |          |
  |          |   MISO(PA.10)|______________________|MISO(PA.10)   |          |
  |          |              |                      |              |          |
  |          |   MOSI(PA.09)|______________________|MOSI(PA.09)   |          |
  |          |              |                      |              |          |
  |          |______________|                      |______________|          |
  |      __                 |                      |                         |
  |     |__|                |                      |                         |
  ...
  |                         |                      |                         |
  |_STM32WBAxx Master_______|                      |_STM32WBAxx Slave________|
...
### <b>Hardware and Software environment</b> 
  ...
  - NUCLEO-WBA25CE Set-up
    - Connect Master board PA8 (CN6, pin 6) to Slave Board PA8 (CN6, pin 6)
    - Connect Master board PA10 (CN6, pin 5) to Slave Board PA10 (CN6, pin 5)
    - Connect Master board PA9 (CN6, pin 4) to Slave Board PA9 (CN6, pin 4)
