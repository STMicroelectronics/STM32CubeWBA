...
Data buffer transmission/reception between two boards via SPI using DMA.
	...
	CLK Pin: PA.08 (pin 6 on CN6 connector)
	MISO Pin: PA.10 (pin 5 on CN6 connector)
	MOSI Pin: PA.9 (pin 4 on CN6 connector)
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-WBA25CE Set-up
    - Connect Master board PA.08 (pin 6 on CN6 connector) to Slave Board PA.08 (pin 6 on CN6 connector)
    - Connect Master board PA.10 (pin 5 on CN6 connector) to Slave Board PA.10 (pin 5 on CN6 connector)
    - Connect Master board PA.9 (pin 4 on CN6 connector) to Slave Board PA.9 (pin 4 on CN6 connector)
