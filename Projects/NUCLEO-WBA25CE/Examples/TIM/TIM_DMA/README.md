...
Use of the DMA with TIMER Update request to transfer data from memory to TIMER Capture Compare Register 3 (TIMx_CCR3).
  ...
  The following configuration values are used in this example:
    ...
    - SystemCoreClock is set to 64 MHz for STM32WBAxx
...
#### <b>Notes</b>  
 ...
 4. To be able to display PWM waveform using an oscilloscope please make sure to close the SB24
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-WBA25CE Set-up
    ...
    - TIM2 CH3 (PA.7 (pin 7 in CN8 connector))
