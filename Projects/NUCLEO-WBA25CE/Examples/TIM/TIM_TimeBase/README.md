...
SystemCoreClock is set to 64 MHz for STM32WBAxx Devices.
...
interrupt is generated and, in the handler routine, pin PA.7 (connected to LD1 on board NUCLEO-WBA25CE)
...
#### <b>Notes</b>
 ...
 3. To be able to display waveform using an oscilloscope please make sure to close the SB24
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-WBA25CE Set-up
    - Use LD1 connected to PA.7 pin (pin 7 in CN8 connector) and connect it on an oscilloscope 
