...
For Keil,only uart configuration is supported
...
For STM32CubeIDE, to display data via the Virtual Com Port using HyperTerminal or TeraTerm, update the following project settings to disable the semihosting feature (Display data on debugger):

- Remove the miscellaneous linker flags "-specs=rdimon.specs" -lc -lrdimon under
under Project -> Properties -> C/C++ Build -> Settings (Tool Settings Tab) -> MCU GCC Linker
- Add "syscalls.c" file to the build.
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with a STM32WBA25CEUx embedded on an
    NUCLEO-WBA25CE board and can be easily tailored to any other supported
