...
an HyperTerminal PC application.
       ...
       - Tx Pin: PA.06 (Pin 37 in CN3) (available through VCP)
       - Rx Pin: PA.12 (Pin 35 in CN3) (available through VCP)

At the beginning of the main program the HAL_Init() function is called to reset
all the peripherals, initialize the Flash interface and the systick.
Then the SystemClock_Config() function is used to configure the system
clock (SYSCLK) to run at 64 MHz for STM32WBAxx Devices.
...
NUCLEO-WBA25CE board LEDs are used to monitor the transfer status:
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics NUCLEO-WBA25CE board and can be
