## __Zigbee_OnOff_Client_Router Application Description__
...
* One B-WBA5M-WPAN Module board loaded with application **Zigbee_OnOff_Server_Coord**
* One or more B-WBA5M-WPAN Module board loaded with application **Zigbee_OnOff_Client_Router**
</br>
...
* This example runs on B-WBA5M-WPAN Modules.  

* This example has been tested with an STMicroelectronics B-WBA5M-WPAN Module board and can be easily tailored to any other supported device and development board.  
