...
/**
  ...
  * @brief   This sample code shows how to use STM32WBAxx RTC HAL API to write/read
...
int main(void)
{
  ...
  /* Disable the tamper  */
  if (HAL_RTCEx_DeactivateTamper(&hrtc, RTC_TAMPER_4) != HAL_OK)
  {
    Error_Handler();
  }
