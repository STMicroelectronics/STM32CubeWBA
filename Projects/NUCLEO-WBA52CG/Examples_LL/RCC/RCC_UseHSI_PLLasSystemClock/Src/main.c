...
{
  {RCC_FREQUENCY_LOW, 4, 20, 20, LL_FLASH_LATENCY_2},
  {RCC_FREQUENCY_HIGH, 2, 50, 2, LL_FLASH_LATENCY_0},
};
...
/**
  ...
  * @param PLL1M parameter can be 4 or  2
  * @param PLLR parameter can be 20 or  2
  * @param PLL1N parameter can be 20 or 50 
  * @retval RCC_ERROR_NONE if no error
  */
uint32_t ChangePLLConfiguration(uint32_t PLLSource, uint32_t PLLM, uint32_t PLLN, uint32_t PLLR)
{
