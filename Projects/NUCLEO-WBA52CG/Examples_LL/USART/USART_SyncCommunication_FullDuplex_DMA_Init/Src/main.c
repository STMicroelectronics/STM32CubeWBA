...
static void MX_SPI1_Init(void)
{
  ...
  */
  ...
  /* (3) Configure the GPDMA1 functional parameters for transmission */

  LL_DMA_ConfigAddresses(GPDMA1, LL_DMA_CHANNEL_2,
                         (uint32_t)aSPI1TxBuffer,
                         (uint32_t)&(SPI1->TXDR));
  LL_DMA_SetBlkDataLength(GPDMA1, LL_DMA_CHANNEL_2, ubSPI1NbDataToTransmit);
  ...
  LL_DMA_SetBlkDataLength(GPDMA1, LL_DMA_CHANNEL_3, ubSPI1NbDataToReceive);
...
static void MX_USART1_Init(void)
{
  ...
  */
  ...
  DMA_InitStruct.TriggerPolarity = LL_DMA_TRIG_POLARITY_MASKED;
  DMA_InitStruct.TriggerSelection = 0x00000000U;
  DMA_InitStruct.Request = LL_GPDMA1_REQUEST_USART1_RX;
  DMA_InitStruct.TransferEventMode = LL_DMA_TCEM_BLK_TRANSFER;
  DMA_InitStruct.SrcAllocatedPort = LL_DMA_SRC_ALLOCATED_PORT0;
  DMA_InitStruct.DestAllocatedPort = LL_DMA_DEST_ALLOCATED_PORT0;
  DMA_InitStruct.LinkAllocatedPort = LL_DMA_LINK_ALLOCATED_PORT1;
  ...
  LL_DMA_ConfigAddresses(GPDMA1, LL_DMA_CHANNEL_4,
                         (uint32_t)aUSART1TxBuffer,
                         LL_USART_DMA_GetRegAddr(USART1, LL_USART_DMA_REG_DATA_TRANSMIT));
  LL_DMA_SetBlkDataLength(GPDMA1, LL_DMA_CHANNEL_4, ubUSART1NbDataToTransmit);

  LL_DMA_ConfigAddresses(GPDMA1, LL_DMA_CHANNEL_5,
                         LL_USART_DMA_GetRegAddr(USART1, LL_USART_DMA_REG_DATA_RECEIVE),
                         (uint32_t)aUSART1RxBuffer);
  LL_DMA_SetBlkDataLength(GPDMA1, LL_DMA_CHANNEL_5, ubUSART1NbDataToReceive);
  ...
  LL_DMA_EnableIT_DTE(GPDMA1, LL_DMA_CHANNEL_5);
...
/**
  * @brief  Function called from GPDMA1 IRQ Handler when Tx transfer is completed (USART1)
  * @param  None
  * @retval None
  */
void USART1_GPDMA1_TransmitComplete_Callback(void)
{
