...
/**
  ******************************************************************************
  * @file    Examples_LL/USART/USART_SyncCommunication_FullDuplex_DMA_Init/Src/stm32wbaxx_it.c
...
void GPDMA1_Channel2_IRQHandler(void)
{
  ...
  if (LL_DMA_IsActiveFlag_TC(GPDMA1, LL_DMA_CHANNEL_2))
  {
    ...
    SPI1_GPDMA1_TransmitComplete_Callback();
  }
...
void GPDMA1_Channel3_IRQHandler(void)
{
  ...
  if (LL_DMA_IsActiveFlag_TC(GPDMA1, LL_DMA_CHANNEL_3))
  {
    ...
    SPI1_GPDMA1_ReceiveComplete_Callback();
  }
  else if (LL_DMA_IsActiveFlag_DTE(GPDMA1, LL_DMA_CHANNEL_3))
  {
    /* Call Error function */
    SPI_TransferError_Callback();
  }
...
void GPDMA1_Channel4_IRQHandler(void)
{
  ...
  if (LL_DMA_IsActiveFlag_TC(GPDMA1, LL_DMA_CHANNEL_4))
  {
    LL_DMA_ClearFlag_TC(GPDMA1, LL_DMA_CHANNEL_4);
    /* Call function Transmission complete Callback */
    USART1_GPDMA1_TransmitComplete_Callback();
  }
  else if (LL_DMA_IsActiveFlag_DTE(GPDMA1, LL_DMA_CHANNEL_4))
  {
    /* Call Error function */
...
void GPDMA1_Channel5_IRQHandler(void)
{
  ...
  if (LL_DMA_IsActiveFlag_TC(GPDMA1, LL_DMA_CHANNEL_5))
  {
    LL_DMA_ClearFlag_TC(GPDMA1, LL_DMA_CHANNEL_5);
    /* Call function Reception complete Callback */
    USART1_GPDMA1_ReceiveComplete_Callback();
  }
  else if (LL_DMA_IsActiveFlag_DTE(GPDMA1, LL_DMA_CHANNEL_5))
  {
    /* Call Error function */
    USART_TransferError_Callback();
  }
