...
/**
  ******************************************************************************
  * @file    Examples_LL/ADC/ADC_SingleConversion_TriggerTimer_DMA_Init/Src/stm32wbaxx_it.c
...
/* Check whether DMA transfer complete caused the DMA interruption */
  ...
  if(LL_DMA_IsActiveFlag_HT(GPDMA1, LL_DMA_CHANNEL_1) == 1)
  {
...
void ADC4_IRQHandler(void)
{
  ...
  if(LL_ADC_IsActiveFlag_OVR(ADC4) != 0)
  {
