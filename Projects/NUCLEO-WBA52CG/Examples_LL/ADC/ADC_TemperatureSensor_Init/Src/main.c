...
int main(void)
{
  ...
  while (1)
  {
    ...
    hADCxConvertedData_Temperature_DegreeCelsius = __LL_ADC_CALC_TEMPERATURE(VDDA_APPLI,
                                                                             uhADCxConvertedData,
...
static void MX_ADC4_Init(void)
{
  ...
  */
  LL_ADC_SetCommonPathInternalCh(__LL_ADC_COMMON_INSTANCE(ADC4), LL_ADC_PATH_INTERNAL_TEMPSENSOR);
  ...
  */
  ...
  LL_ADC_SetSamplingTimeCommonChannels(ADC4, LL_ADC_SAMPLINGTIME_COMMON_1, LL_ADC_SAMPLINGTIME_814CYCLES_5);
  LL_ADC_SetSamplingTimeCommonChannels(ADC4, LL_ADC_SAMPLINGTIME_COMMON_2, LL_ADC_SAMPLINGTIME_1CYCLE_5);
  ...
  /** Configure Regular Channel
  */
  LL_ADC_REG_SetSequencerRanks(ADC4, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_TEMPSENSOR);
  LL_ADC_SetChannelSamplingTime(ADC4, LL_ADC_CHANNEL_TEMPSENSOR, LL_ADC_SAMPLINGTIME_COMMON_1);
