...
int main(void)
{
  ...
  while (1)
  {
    ...
    uhADCxConvertedData_OVS_ratio16_shift4 = LL_ADC_REG_ReadConversionData32(ADC4);
    ...
    uhADCxConvertedData_OVS_ratio16_shift0 = LL_ADC_REG_ReadConversionData32(ADC4);
    ...
    /* to ADC resolution: 12 bits)                                            */
    uhADCxConvertedData_OVS_disabled = LL_ADC_REG_ReadConversionData32(ADC4);
    ...
    /* - shift: 4                                                             */
    /* Set ADC oversampling scope */
    LL_ADC_SetOverSamplingScope(ADC4, LL_ADC_OVS_GRP_REGULAR_CONTINUED);
...
static void MX_ADC4_Init(void)
{
  ...
  */
  LL_ADC_ConfigOverSamplingRatioShift(ADC4, LL_ADC_OVS_RATIO_16, LL_ADC_OVS_SHIFT_RIGHT_4);
  LL_ADC_SetOverSamplingDiscont(ADC4, LL_ADC_OVS_REG_CONT);
  LL_ADC_SetTriggerFrequencyMode(ADC4, LL_ADC_TRIGGER_FREQ_LOW);
  ADC_InitStruct.Resolution = LL_ADC_RESOLUTION_12B;
  ADC_InitStruct.DataAlignment = LL_ADC_DATA_ALIGN_RIGHT;
  LL_ADC_Init(ADC4, &ADC_InitStruct);
  LL_ADC_REG_SetSequencerConfigurable(ADC4, LL_ADC_REG_SEQ_CONFIGURABLE);
  ...
  LL_ADC_SetLPModeAutoPowerOff(ADC4, DISABLE);
  LL_ADC_SetLPModeAutonomousDPD(ADC4, LL_ADC_LP_AUTONOMOUS_DPD_DISABLE);
  LL_ADC_SetSamplingTimeCommonChannels(ADC4, LL_ADC_SAMPLINGTIME_COMMON_1, LL_ADC_SAMPLINGTIME_79CYCLES_5);
  LL_ADC_SetSamplingTimeCommonChannels(ADC4, LL_ADC_SAMPLINGTIME_COMMON_2, LL_ADC_SAMPLINGTIME_79CYCLES_5);
  ...
  */
  LL_ADC_REG_SetSequencerRanks(ADC4, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_2);
  LL_ADC_SetChannelSamplingTime(ADC4, LL_ADC_CHANNEL_2, LL_ADC_SAMPLINGTIME_COMMON_1);
