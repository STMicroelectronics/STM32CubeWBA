...
static void MX_ADC4_Init(void)
{
  ...
  */
  LL_ADC_SetAnalogWDMonitChannels(ADC4, LL_ADC_AWD1, LL_ADC_AWD_ALL_CHANNELS_REG);
  LL_ADC_ConfigAnalogWDThresholds(ADC4, LL_ADC_AWD1, ADC_AWD_THRESHOLD_HIGH, ADC_AWD_THRESHOLD_LOW);
...
/**
  ...
  *         (ADC instance: ADC4, analog watchdog instance: AWD1).
  * @param  None
  * @retval None
  */
void ADC_AnalogWatchdog_Rearm(void)
...
void AdcAnalogWatchdog1_Callback()
{
  ...
  uhADCxConvertedData = LL_ADC_REG_ReadConversionData32(ADC4);
