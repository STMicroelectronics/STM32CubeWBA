...
#define BSP_BUTTON1_IT_PRIORITY 0x0FUL  /* Default is lowest priority level */
#define BSP_BUTTON2_IT_PRIORITY 0x0FUL  /* Default is lowest priority level */
#define BSP_BUTTON3_IT_PRIORITY 0x0FUL  /* Default is lowest priority level */
