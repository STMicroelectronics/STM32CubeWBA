...
/**
  ******************************************************************************
  * @file    Applications/Sequencer/Sequencer_gpio_toggle_lowpower/Src/main.c
  * @author  MCD Application Team
  * @brief   This example describes how to use a task of the sequencer
  *          to toggle a GPIO.
  ******************************************************************************
  * @attention
  *
