...
set "sbsfu_s=%projectdir%\Secure\NUCLEO-WBA52CG_S\Exe\Project.bin"
set "sbsfu_ns=%projectdir%\NonSecure\NUCLEO-WBA52CG_NS\Exe\Project.bin"
...
echo "===============================================================" >> %projectdir%\\output.txt
echo " Which version of tool is used :" >> %projectdir%\\output.txt
%imgtool% version -b >> %projectdir%\\output.txt
echo "===============================================================" >> %projectdir%\\output.txt
echo "" >> %projectdir%\\output.txt
exit 1
:error_clear
