...
static const char a_GapDeviceName[] = {  'H', 'e', 'a', 'r', 't', 'R', 'a', 't', 'e', 'M', 'X' }; /* Gap Device Name */
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      HRSHandleNotification.ConnectionHandle = bleAppContext.BleApplicationContext_legacy.connectionHandle;
      DISHandleNotification.ConnectionHandle = bleAppContext.BleApplicationContext_legacy.connectionHandle;
...
static void APP_BLE_AdvLowPower_timCB(void *arg)
{
   ...
   */
  UTIL_SEQ_SetTask(1<<CFG_TASK_ADV_LP_REQ_ID, CFG_SCH_PRIO_0);
