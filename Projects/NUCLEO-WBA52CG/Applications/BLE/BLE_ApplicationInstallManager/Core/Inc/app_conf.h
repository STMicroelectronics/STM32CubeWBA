 ...
 */
#define CFG_NVM_STATIC_NB_SECTORS                          (4)
/**
 * Define the User Configuration size in sector
 */
#define CFG_USER_CFG_NB_SECTORS                            (1)
/**
 * Define the start address where the User Configuration shall be located
 */
#define CFG_USER_CFG_SLOT_START_SECTOR_INDEX             (FLASH_PAGE_NB - CFG_NVM_STATIC_NB_SECTORS - CFG_USER_CFG_NB_SECTORS)
/**
 ...
 */
#define CFG_DOWNLOAD_ACTIVE_NB_SECTORS              (FLASH_PAGE_NB - CFG_NVM_STATIC_NB_SECTORS - CFG_USER_CFG_NB_SECTORS)
/**
 * Size in Page of Download or active slot
 */
#define CFG_APP_SLOT_PAGE_SIZE            ((CFG_DOWNLOAD_ACTIVE_NB_SECTORS - CFG_ACTIVE_SLOT_START_SECTOR_INDEX) / 2)
/**
 * Define the start address where the NEW application shall be downloaded
 */
#define CFG_DOWNLOAD_SLOT_START_SECTOR_INDEX    (CFG_APP_SLOT_PAGE_SIZE + CFG_ACTIVE_SLOT_START_SECTOR_INDEX)
...
#define USE_TEMPERATURE_BASED_RADIO_CALIBRATION  (0)       /* Link Layer uses temperature based calibration (0 --> NO)
                                                            *                                               (1 --> YES)
                                                            */
