...
### __Directory contents__
  ...
  - BLE_p2pServer_Ext/System/Modules/general_config.h                               This file contains definitions that can be changed to configure some modules of the STM32 firmware application
...
In order to make the program work, you must do the following :
 ...
 You can interact with p2pServer_Ext application with a smartphone:
 ...
 You can interact with p2pServer_Ext application with another Nucleo board running p2pClient_Ext:
...
You can interact with p2pServer_Ext application with another Nucleo board running p2pClient:
