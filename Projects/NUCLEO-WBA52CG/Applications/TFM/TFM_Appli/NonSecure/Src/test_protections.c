...
const TestProtection_t aProtectTests[] =
{
    ...
    { S_RAM_ALIAS(BOOT_SHARED_DATA_BASE - _SRAM1_BASE_S), "Secure Write", TEST_WRITE_DMA, NOT_APPLICABLE, DENIED},
...
const TestProtection_t aProtectTests[] =
{
    { (uint32_t)DMA_CONST, "NPRIV SEC", TEST_READ_DMA, NOT_APPLICABLE, ALLOWED},
    { (uint32_t)DMA_NON_SECURE, "NPRIV SEC", TEST_WRITE_DMA, NOT_APPLICABLE,  ALLOWED},
    { (uint32_t) &GTZC_TZIC->IER3, "GTZC1_TZCIC IER3", TEST_WRITE_PERIPH, NOT_APPLICABLE, SILENT},
    { (uint32_t) &GTZC_TZIC->IER3, "GTZC2_TZCIC IER3", TEST_READ_PERIPH, NOT_APPLICABLE, SILENT},
    ...
    {  S_RAM_ALIAS(BOOT_SHARED_DATA_BASE - SRAM1_BASE_S), "BL2 SHARED", TEST_WRITE_DMA, NOT_APPLICABLE, SILENT},
    ...
    {  S_RAM_ALIAS(BOOT_SHARED_DATA_BASE - SRAM1_BASE_S), "BL2 SHARED", TEST_READ_RAM, NOT_APPLICABLE, DENIED},
...
#endif /* MCUBOOT_S_DATA_IMAGE_NUMBER == 1 */
    {  (uint32_t)S_DATA_LIMIT, "Data Secure Start", TEST_READ_RAM, NOT_APPLICABLE, ALLOWED},
    ...
    { (uint32_t) BOOT_SHARED_DATA_BASE - 1, "BL2 SHARED-1", TEST_PRIV_WRITE_RAM, NOT_APPLICABLE, SILENT},
    { (uint32_t) BOOT_SHARED_DATA_BASE, "BL2 SHARED", TEST_PRIV_WRITE_RAM, NOT_APPLICABLE, DENIED},
    { (uint32_t) BOOT_SHARED_DATA_BASE + BOOT_SHARED_DATA_SIZE, "BL2 SHARED End +1", TEST_PRIV_WRITE_RAM, NOT_APPLICABLE, ALLOWED},
    { (uint32_t) BOOT_SHARED_DATA_BASE + BOOT_SHARED_DATA_SIZE-1, "BL2 SHARED End", TEST_PRIV_WRITE_RAM, NOT_APPLICABLE, DENIED},
