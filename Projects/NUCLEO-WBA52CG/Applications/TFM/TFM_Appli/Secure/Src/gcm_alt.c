                ...
                unsigned char *output )
{
    ...
    size_t use_len;
#else
    uint16_t wordnb;          /* number of four data words */
    uint16_t wordlen;         /* length (in bytes) of four data words */
...
last_data_word:
    ...
    work_buf_len = (length - in_datalen) % 16U;
