...
set "maxbytesize=440"
set "loader_s=%projectdir%\Secure\NUCLEO-WBA52CG_S\Exe\Project.bin"
set "loader_ns=%projectdir%\NonSecure\NUCLEO-WBA52CG_NS\Exe\Project.bin"
...
set "nsclib_source=%projectdir%\Secure\NUCLEO-WBA52CG_S\Exe\Project_import_lib.o"
