...
:set_version_end
set "signing=%~3"
set "userAppBinary=%projectdir%\..\..\TFM_Appli\Binary"
IF "%4"=="" (
goto :veropt;
)
set "dep=%~4"
...
set "tfm_s_init=%userAppBinary%\tfm_s_data_init%ver%.bin"
set "tfm_ns_init=%userAppBinary%\tfm_ns_data_init%ver%.bin"
set "tfm_s_sign=%userAppBinary%\tfm_s_data_sign%ver%.bin"
set "tfm_ns_sign=%userAppBinary%\tfm_ns_data_sign%ver%.bin"
set "tfm_s_enc_sign=%userAppBinary%\tfm_s_data_enc_sign%ver%.bin"
set "tfm_ns_enc_sign=%userAppBinary%\tfm_ns_data_enc_sign%ver%.bin"
...
set "tfm_s=%projectdir%\..\..\TFM_SBSFU_Boot\Src\s_data.bin"
set "tfm_ns=%projectdir%\..\..\TFM_SBSFU_Boot\Src\ns_data.bin"
...
set "command_init_ns=%python%%imgtool% sign -k %key_ns% %encrypt% -e little -S %image_ns_size% -M %image_ns_sectors% -H 0x20 --pad-header %option% -v %version% --confirm --pad -s auto --align %val% %tfm_ns% %tfm_ns_init% >> %projectdir%\output.txt 2>&1"
%command_init_ns%
IF %ERRORLEVEL% NEQ 0 goto :error_init_ns

echo "%signing% clear ns image signing" >> %projectdir%\output.txt 2>&1
set "command_clear_ns=%python%%imgtool% sign -k %key_ns% -e little -S %image_ns_size% -M %image_ns_sectors% -H 0x20 --pad-header %option% -v %version% -s auto --align %val% %tfm_ns% %tfm_ns_sign% >> %projectdir%\output.txt 2>&1"
%command_clear_ns%
...
set "command_enc_ns=%python%%imgtool% sign -k %key_ns% -E %key_enc_pub% -e little -S %image_ns_size% -M %image_ns_sectors% -H 0x20 --pad-header %option% -v %version%  -s auto --align %val% %tfm_ns% %tfm_ns_enc_sign% >> %projectdir%\output.txt 2>&1"
%command_enc_ns%
...
set "command_init_s=%python%%imgtool% sign -k %key_s% %encrypt% -e little -S %image_s_size% -M %image_s_sectors% -H 0x20 --pad-header %option% -v %version% --confirm --pad -s auto --align %val% %tfm_s% %tfm_s_init% >> %projectdir%\output.txt 2>&1"
%command_init_s%
IF %ERRORLEVEL% NEQ 0 goto :error_init_s

echo "%signing% clear s image signing" >> %projectdir%\output.txt 2>&1
set "command_clear_s=%python%%imgtool% sign -k %key_s% -e little -S %image_s_size% -M %image_s_sectors% -H 0x20 --pad-header %option% -v %version% -s auto --align %val% %tfm_s% %tfm_s_sign% >> %projectdir%\output.txt 2>&1"
%command_clear_s%
...
set "command_enc_s=%python%%imgtool% sign -k %key_s% -E %key_enc_pub% -e little -S %image_s_size% -M %image_s_sectors% -H 0x20 --pad-header %option% -v %version%  -s auto --align %val% %tfm_s% %tfm_s_enc_sign% >> %projectdir%\output.txt 2>&1"
%command_enc_s%
