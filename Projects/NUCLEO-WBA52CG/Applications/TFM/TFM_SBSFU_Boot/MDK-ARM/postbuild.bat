...
set "update=%projectdir%\TFM_UPDATE.bat"
set "postbuild_appli=%projectdir%\..\..\TFM_Appli\MDK-ARM\postbuild.bat"
set "postbuild_loader=%projectdir%\..\..\TFM_Loader\MDK-ARM\postbuild.bat"
