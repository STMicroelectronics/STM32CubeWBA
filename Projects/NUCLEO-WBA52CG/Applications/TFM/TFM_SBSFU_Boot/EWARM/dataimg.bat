...
set "command_init_ns=%imgtool% sign -k %key_ns% %encrypt% -e little -S %image_ns_size% %flag% %image_ns_sectors% -H 0x20 --pad-header %option% -v %version% --confirm --pad -s auto --align %val% %tfm_ns% %tfm_ns_init% >> %projectdir%\output.txt 2>&1"
%command_init_ns%
IF %ERRORLEVEL% NEQ 0 goto :error_init_ns

echo "%signing% clear ns image signing" >> %projectdir%\output.txt 2>&1
set "command_clear_ns=%imgtool% sign -k %key_ns% -e little -S %image_ns_size% %flag% %image_ns_sectors% -H 0x20 --pad-header %option% -v %version% -s auto --align %val% %tfm_ns% %tfm_ns_sign% >> %projectdir%\output.txt 2>&1"
%command_clear_ns%
...
set "command_enc_ns=%imgtool% sign -k %key_ns% -E %key_enc_pub% -e little -S %image_ns_size% %flag% %image_ns_sectors% -H 0x20 --pad-header %option% -v %version%  -s auto --align %val% %tfm_ns% %tfm_ns_enc_sign% >> %projectdir%\output.txt 2>&1"
%command_enc_ns%
...
set "command_init_s=%imgtool% sign -k %key_s% %encrypt% -e little -S %image_s_size% %flag% %image_s_sectors% -H 0x20 --pad-header %option% -v %version% --confirm --pad -s auto --align %val% %tfm_s% %tfm_s_init% >> %projectdir%\output.txt 2>&1"
%command_init_s%
IF %ERRORLEVEL% NEQ 0 goto :error_init_s

echo "%signing% clear s image signing" >> %projectdir%\output.txt 2>&1
set "command_clear_s=%imgtool% sign -k %key_s% -e little -S %image_s_size% %flag% %image_s_sectors% -H 0x20 --pad-header %option% -v %version% -s auto --align %val% %tfm_s% %tfm_s_sign% >> %projectdir%\output.txt 2>&1"
%command_clear_s%
...
set "command_enc_s=%imgtool% sign -k %key_s% -E %key_enc_pub% -e little -S %image_s_size% %flag% %image_s_sectors% -H 0x20 --pad-header %option% -v %version%  -s auto --align %val% %tfm_s% %tfm_s_enc_sign% >> %projectdir%\output.txt 2>&1"
%command_enc_s%
