...
set "command_key=%imgtool% getpub -k %key_rsa_s%  > %tfm_keys%"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
...
set "command_key=%imgtool% getpub -k %key_rsa_ns%  >> %tfm_keys%"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
...
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
set "command_key=%imgtool%  getpriv  --minimal -k %key_rsa_enc_priv%  >> %tfm_keys%"
%command_key%
...
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
set "command_key=%imgtool% getpub -k %key_rsa_2_s%  >> %tfm_keys%"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
...
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
set "command_key=%imgtool% getpub -k %key_rsa_2_ns%  >> %tfm_keys%"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
...
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
set "command_key=%imgtool% getpub -k %key_ecc_s%  >> %tfm_keys%"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
...
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
set "command_key=%imgtool% getpub -k %key_ecc_ns%  >> %tfm_keys%"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
...
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
set "command_key=%imgtool% getpriv  --minimal -k %key_ecc_enc_priv%  >> %tfm_keys%"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
::eat key
set "key_eat=%tfm_key_dir%\tfm_initial_attestation_key.pem"
set "command_key=%imgtool% keygen -k %key_eat% -t ecdsa-p256-ssl"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
set "command_key=%imgtool% getpriv --minimal -k %key_eat%  >> %tfm_keys%"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
set "command_key=%imgtool% getprivbin --minimal -k %key_eat%  > %key_eat_priv_bin%"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
::huk key
set "key_huk=%tfm_key_dir%\huk.bin"
set "command_key=%imgtool% keygen -k %key_huk% -t sym32"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
set "command_key=%imgtool% getpriv -k %key_huk%  >> %tfm_keys%"
%command_key%
IF %ERRORLEVEL% NEQ 0 goto :error_key
exit 0
