...
File | Description
 --- | ---
  ...
  Templates/TrustZoneEnabled_NoIsolation/Inc/b_wba6m_wpan_conf.h   | BSP Configuration file
...
- This template has been tested with STMicroelectronics B-WBA6M-WPAN (MB2304) board and can be easily
