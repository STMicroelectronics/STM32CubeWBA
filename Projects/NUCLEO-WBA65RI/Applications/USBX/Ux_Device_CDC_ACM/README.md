...
This application provides an example of Azure RTOS USBX stack usage on NUCLEO-WBA65RI board, it shows how to develop USB Device communication Class "CDC_ACM" based application.
