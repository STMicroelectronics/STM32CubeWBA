...
void APP_BLE_Init(void)
{
  ...
  BleStackThread = osThreadNew(BleStack_Task_Entry, NULL, &stBleStackTaskAttributes);
  ...
  HCIasyncEvtThread = osThreadNew(BleUserEvtRx_Task_Entry, NULL, &stHCIasyncEvtTaskAttributes);
