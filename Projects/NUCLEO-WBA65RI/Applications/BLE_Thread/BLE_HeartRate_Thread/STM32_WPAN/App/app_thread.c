...
#ifdef APP_THREAD_PERIODIC_TRANSMIT
/**
 * @brief  Set Task associated to the push button 1.
 * @param  arg
 * @retval None
 */
static void APP_THREAD_SetButton1Action(void *arg)
{
  UTIL_SEQ_SetTask(TASK_BUTTON_B1, CFG_SEQ_PRIO_1);
}
#endif
