## __ZigbeeDirect_OnOff_Server_Router_Identify Application Description__
</br>
...
* One IOS device loaded with Ubisys Smart Home application or Ledvance Direct Easy application
