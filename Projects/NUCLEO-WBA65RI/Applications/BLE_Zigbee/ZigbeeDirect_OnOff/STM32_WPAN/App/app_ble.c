...
static char a_GapDeviceName[] = {  'Z', 'i', 'g', 'b', 'e', 'e', 'D', 'i', 'r', 'e', 'c', 't', 'D', 'e', 'v', 'i', 'c', 'e' }; /* Gap Device Name */
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          if (aci_gatt_exchange_config(p_conn_complete->Connection_Handle) != BLE_STATUS_SUCCESS)
          {
