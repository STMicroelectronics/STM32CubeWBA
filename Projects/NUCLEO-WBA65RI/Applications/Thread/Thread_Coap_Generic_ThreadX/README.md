## __Thread_Coap_Generic_ThreadX Application Description__
...
* This example has been tested with an STMicroelectronics STM32WBA65RIVx_Nucleo board and can be easily tailored to any other supported device and development board.  
