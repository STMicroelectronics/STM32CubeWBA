...
#define CFG_HW_TS_RTC_WAKEUP_HANDLER_ID RTC_S_IRQn
...
#define CFG_HW_USART1_DMA_RX_SUPPORTED  0

#define CFG_HW_USART2_ENABLED           1
#define CFG_HW_USART2_DMA_TX_SUPPORTED  1
...
/** < The application shall check the selected source clock is enable */
#define CFG_HW_USART1_SOURCE_CLOCK            RCC_USART1CLKSOURCE_HSI
...
#define CFG_HW_USART1_TX_PULL                 GPIO_PULLDOWN
...
#define CFG_HW_USART1_RX_PULL                 GPIO_PULLDOWN
...
/** < The application shall check the selected source clock is enable */
#define CFG_HW_USART2_SOURCE_CLOCK            RCC_USART2CLKSOURCE_HSI

/** < Copy USART1 config for coherency */
#define CFG_HW_USART2_BAUDRATE                CFG_HW_USART1_BAUDRATE
#define CFG_HW_USART2_WORDLENGTH              CFG_HW_USART1_WORDLENGTH
#define CFG_HW_USART2_STOPBITS                CFG_HW_USART1_STOPBITS
#define CFG_HW_USART2_PARITY                  CFG_HW_USART1_PARITY
#define CFG_HW_USART2_HWFLOWCTL               CFG_HW_USART1_HWFLOWCTL
#define CFG_HW_USART2_MODE                    CFG_HW_USART1_MODE
#define CFG_HW_USART2_OVERSAMPLING            CFG_HW_USART1_OVERSAMPLING
#define CFG_HW_USART2_PRESCALER               CFG_HW_USART1_PRESCALER
...
#define CFG_HW_USART2_TX_PULL                 GPIO_PULLDOWN
...
#define CFG_HW_USART2_RX_PULL                 GPIO_PULLDOWN
#define CFG_HW_USART2_RX_SPEED                GPIO_SPEED_FREQ_HIGH
#define CFG_HW_USART2_RX_ALTERNATE            0x03

#define CFG_HW_USART2_DMA_TX_PREEMPTPRIORITY  0x06
#define CFG_HW_USART2_DMA_TX_SUBPRIORITY      0

#define CFG_HW_USART2_DMA_CLK_ENABLE          __HAL_RCC_GPDMA1_CLK_ENABLE
#define CFG_HW_USART2_TX_DMA_REQ	      GPDMA1_REQUEST_USART1_TX
#define CFG_HW_USART2_TX_DMA_CHANNEL          GPDMA1_Channel2_NS
#define CFG_HW_USART2_TX_DMA_IRQn             GPDMA1_Channel2_IRQn
#define CFG_HW_USART2_DMA_TX_IRQHandler       GPDMA1_Channel2_IRQHandler
