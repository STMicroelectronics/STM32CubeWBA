...
static char a_GapDeviceName[] = {  'S', 'e', 'r', 'i', 'a', 'l', 'P', 'o', 'r', 't', '_', 'S', 'e', 'r', 'v', 'e', 'r' }; /* Gap Device Name */
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          SERIALPORT_SERVERHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          SERIALPORT_SERVER_APP_EvtRx(&SERIALPORT_SERVERHandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          SERIALPORT_SERVERHandleNotification.EvtOpcode = SERIALPORT_SERVER_CONN_HANDLE_EVT;
          SERIALPORT_SERVERHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          SERIALPORT_SERVER_APP_EvtRx(&SERIALPORT_SERVERHandleNotification);
        ...
        default:
        {
          ...
          LOG_INFO_APP("HCI_LE_META_EVT: 0x%02X\n", p_meta_evt->subevent);
...
{
  tBleStatus status;
  status = aci_gap_peripheral_security_req(bleAppContext.connectionHandle);
  if (status != BLE_STATUS_SUCCESS)
  {
