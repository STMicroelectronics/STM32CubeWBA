...
/* Private defines -----------------------------------------------------------*/
#define TM_SPI_CS_Pin GPIO_PIN_9
#define TM_SPI_CS_GPIO_Port GPIOB
#define TM_SPI_CS_EXTI_IRQn EXTI9_IRQn
#define TM_SPI_IRQ_Pin GPIO_PIN_3
#define TM_SPI_IRQ_GPIO_Port GPIOH
