...
How to communicate with the STM32CubeMonitor-RF Tool using the transparent mode through USB Communication Device Class (CDC)
...
To test the BLE Transparent Mode application, use the STM32CubeMonitor-RF tool:  
 ...
 - Make the connection between STM32CubeMonitor RF tool and BLE_TransparentMode application through the Virtual COM Port of the User USB connector (not the ST-Link one).
