...
/* Advertising Data */
uint8_t a_AdvData[28] =
{
  7, AD_TYPE_COMPLETE_LOCAL_NAME, 'E', 'C', 'G', '_', 'X', 'X',  /* Complete name */
 ...
 * The MagicKeywordAdress shall be mapped just after the end of the interrupt vector table
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
    {
      ...
      switch (p_blecore_evt->ecode)
      {
        ...
        case ACI_L2CAP_CONNECTION_UPDATE_RESP_VSEVT_CODE:
        {
          ...
          UTIL_SEQ_SetEvt(1 << CFG_IDLEEVT_GAP_UPDATE_CONNECTION_COMPLETE);
