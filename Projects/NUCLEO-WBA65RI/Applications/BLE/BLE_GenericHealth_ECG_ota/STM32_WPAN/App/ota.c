      ...
      switch(p_blecore_evt->ecode)
      {
        case ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE:
        {
          ...
          else if(p_attribute_modified->Attr_Handle == (OTA_Context.Raw_DataCharHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))
          {
            ...
            /* USER CODE BEGIN Service4_Char_3_ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE */
            /**
             * Raw Data
             */
            notification.DataTransfered.p_Payload = (uint8_t*)&p_attribute_modified->Attr_Data[0];
            notification.DataTransfered.Length = p_attribute_modified->Attr_Data_Length;
            /* USER CODE END Service4_Char_3_ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE */
            OTA_Notification(&notification);
          }
        ...
        case ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE:
        {
          ...
          {
            return_value = SVCCTL_EvtAckFlowEnable;
            /*USER CODE BEGIN Service4_Char_3_ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE */
            ...
            /*USER CODE END Service4_Char_3_ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE*/
          }
