...
int main(void)
{
  ...
  /*--- If USER push-button is pushed, Set or reset SWAP_BANK option bit to enable or disable
  ...
  while (1)
  {
    ...
    if (BSP_PB_GetState(B1) == RESET)
    {
      while (BSP_PB_GetState(B1) == RESET);
