...
<Root xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="SCHVerif.xsd">
  <McubootFormat>
    <GlobalParam>
      ...
      <LinkedXML>./../../../../ROT_Provisioning/SM/Config/SM_Config_Keys.xml</LinkedXML>
    </GlobalParam>
    <Param>
    ...
    <Param>
      <Name>Dependency with Secure Manager image</Name>
      <Value>0,1.0.0</Value>
      <Type>Dependency</Type>
      <Command>-d</Command>
      <Enable>0</Enable>
      <Tooltip>To be enabled when a compatibility with a specific Secure Manager image version is required. Image version format is x.y.z</Tooltip>
      <Default>0,1.0.0</Default>
    </Param>
    <Param>
      <Name>Dependency with Module 0 image</Name>
      <Value>2,2.0.0</Value>
      <Type>Dependency</Type>
      <Command>-d</Command>
      <Enable>0</Enable>
      <Tooltip>To be enabled when a compatibility with a specific Module 0 image version is required. Image version format is x.y.z</Tooltip>
