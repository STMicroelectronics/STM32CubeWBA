...
remove_protect="-ob SECWM1_STRT=1 SECWM1_END=0 WRPSGn1=0xff WRPSGn2=0xff SECWM2_STRT=1 SECWM2_END=0 HDP1_STRT=1 HDP1_END=0 HDP2_STRT=1 HDP2_END=0 SECBOOT_LOCK=0xC3"
erase_all="-e all"
...
"$stm32programmercli" $connect_no_reset -ob SECWM1_STRT=0x1 SECWM1_END=0x1
if [ $? -ne 0 ]; then error; return 1; fi
"$stm32programmercli" $connect_no_reset -ob SECWM2_STRT=0x1 SECWM2_END=0x01
if [ $? -ne 0 ]; then error; return 1; fi
