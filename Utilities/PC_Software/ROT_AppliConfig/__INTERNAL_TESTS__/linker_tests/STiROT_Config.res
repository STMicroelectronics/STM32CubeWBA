...
<Obdata>
	...
	<Bool>
		<Name>Jump into ST bootloader when no valid image</Name>
		<Value>0x00</Value>
		<Width>1</Width>
		<Hidden>1</Hidden>
		...
		<True>0x01</True>
		<False>0x00</False>
		<Tooltip>Tick the box if STiROT is allowed to jump into ST bootloader when the authenticity and the integrity of the image are not verified</Tooltip>
	</Bool>
	<Bool>
	...
	<Data>
		...
		<Slot>size#1</Slot>
		<Tooltip>Enter the size of the firmware areas (aligned on 4 Kbytes)</Tooltip>
	</Data>
	<Data>
		<Name>Reserved2</Name>
		<Value>0x00</Value>
	...
	<Data>
		<Name>External non-volatile memory size</Name>
		<Value>0x10000000</Value>
		<Width>4</Width>
		<Hidden>1</Hidden>
		<Default>0x10000000</Default>
		<Tooltip>Enter the size of the external non-volatile memory</Tooltip>
	</Data>
	<List>
