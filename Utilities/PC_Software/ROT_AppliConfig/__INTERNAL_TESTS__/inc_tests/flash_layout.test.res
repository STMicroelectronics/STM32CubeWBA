 ...
 * above.
 */
#define LOADER_FLASH_DEV_NAME             TFM_Driver_EXT_FLASH0
...
/* BL2 partitions size */
#if (OEMIROT_LOAD_AND_RUN == LOAD_AND_RUN_INT_RAM)
#define FLASH_PARTITION_SIZE            (2*FLASH_AREA_IMAGE_SECTOR_SIZE) /* 128 kBytes */
#else /* not (OEMIROT_LOAD_AND_RUN == LOAD_AND_RUN_INT_RAM) */
#define FLASH_PARTITION_SIZE            (0x00200000) /* 2 MBytes */
#endif /* OEMIROT_LOAD_AND_RUN == LOAD_AND_RUN_INT_RAM */

#define FLASH_MAX_DATA_PARTITION_SIZE   (0x0)
#define FLASH_MAX_APP_PARTITION_SIZE    (0x2000+FLASH_PARTITION_SIZE)
...
#define FLASH_PRIMARY_NONSECURE_DEV_NAME           TFM_Driver_EXT_FLASH0
#define FLASH_DEV_NAME                             TFM_Driver_FLASH0
#define EXT_FLASH_DEV_NAME                         TFM_Driver_EXT_FLASH0
